          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25><bean:message key="page.invoicePolosTitle.title"/></TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/invoicePolos/list">
...
%>
                <logic:iterate id="invoice" name="INVOICE" type="com.mpe.financial.model.InvoicePolos">
								<% 
									sequence++;
                	...
                	<td>	
                		...
                		<bean:write name="invoice" property="customer.company" scope="page"/>
									...
									<td><bean:write name="invoice" property="formatedInvoicePolosAfterDiscountAndTaxAndPrepayment" scope="page"/>&nbsp;
                  ...
                  <td align="center">
										<html:link page="/invoicePolos/detail.do" paramId="invoiceId" paramName="invoice" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/invoicePolos/form.do" paramId="invoiceId" paramName="invoice" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<a href="#" onclick="window.open('<html:rewrite page="/invoicePolos/printed.do"/>?invoiceId=<bean:write name="invoice" property="id"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');"><html:img page="/images/print.gif" border="0" alt="Print"/></a>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="50%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/invoicePolos/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
