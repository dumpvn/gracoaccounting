        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/paidCreditCard/list">
    			...
    			<tr>
                  ...
                  <td>
                  	<html:select property="locationId">
    						...
    						<tr>
    							<td><bean:message key="page.paidDate.title"/></td><td>:</td><td><html:text property="paidDate" size="12"/>&nbsp;(dd/MM/yyyy)&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
    						</tr>
    					</table>
    				</td>
    			</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('PaidDate')><bean:message key="page.paidDate.title"/></a>&nbsp;<logic:match name="paidCreditCardForm" property="orderBy" value="PaidDate"><logic:match name="paidCreditCardForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="paidCreditCardForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('CreditCardNumber')><bean:message key="page.creditCard.title"/></a>&nbsp;<logic:match name="paidCreditCardForm" property="orderBy" value="CreditCardNumber"><logic:match name="paidCreditCardForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="paidCreditCardForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="paidCreditCard" name="PAIDCREDITCARD" type="com.mpe.financial.model.PaidCreditCard">
                	...
                	<td align="right"><%=++i%>.</td>
                	<td><bean:write name="paidCreditCard" property="paidDate" scope="page"/></td>
									<td><bean:write name="paidCreditCard" property="creditCardNumber" scope="page"/></td>
									<td><bean:write name="paidCreditCard" property="adm" scope="page"/></td>
									<td><bean:write name="paidCreditCard" property="amount" scope="page"/></td>
                  <td align="center">
										<html:link page="/paidCreditCard/detail.do" paramId="paidCreditCardId" paramName="paidCreditCard" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/paidCreditCard/form.do" paramId="paidCreditCardId" paramName="paidCreditCard" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="30%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.paidCreditCard.href=('<html:rewrite page="/paidCreditCard/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
