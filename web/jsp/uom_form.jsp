          ...
          <tr> 
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="65%">
                  	<html:select property="type">
											<html:option value="dimension">Dimension</html:option>
											<html:option value="volume">Volume</html:option>
											<html:option value="weight">Weight</html:option>
                  	</html:select>
                  </td>
                </tr>
                <logic:equal name="uomForm" property="uomId" value="0">
                <tr> 
                ...
                <logic:greaterThan name="uomForm" property="uomId" value="0">
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.name.title"/></td>
                  <td width="5%" align="center">:</td>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="symbol" size="10"/></td>
                </tr>
              </table>
            </td>
          </tr>
