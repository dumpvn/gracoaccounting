        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/journalType/save">
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="5%">:</td>
                  <td width="65%">
										<html:radio property="type" value="GENERAL"/>&nbsp;General&nbsp;
										<html:radio property="type" value="AP"/>&nbsp;Account Payable&nbsp;
										<html:radio property="type" value="AR"/>&nbsp;Account Receivable&nbsp;
										<html:radio property="type" value="INVENTORY"/>&nbsp;Inventory&nbsp;
										<html:radio property="type" value="BANK"/>&nbsp;Bank&nbsp;
									</td>
                </tr>
                <tr> 
