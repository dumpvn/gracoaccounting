        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/invoicePolos/save">
          ...
          <tr>
			...
			%>
			                ...
			                <logic:iterate id="invoiceDetail" name="invoiceDetailLst" type="com.mpe.financial.model.InvoicePolosDetail">
			                ...
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="formatedInvoicePolosDetailAmount"><bean:write name="formatedInvoicePolosDetailAmount"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="formatedInvoicePolosDiscountAmount"><bean:write name="formatedInvoicePolosDiscountAmount"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="formatedInvoicePolosAfterDiscountAmount"><bean:write name="formatedInvoicePolosAfterDiscountAmount"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <!--
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="formatedInvoicePolosTaxAmount"><bean:write name="formatedInvoicePolosTaxAmount"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="formatedInvoicePolosAfterDiscountAndTax"><bean:write name="formatedInvoicePolosAfterDiscountAndTax"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                -->
          ...
          <tr>
			...
			%>
			                ...
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		<logic:present name="formatedInvoicePolosPrepaymentAmount">
			                		<logic:present name="invoice" property="currency">
													<bean:write name="invoice" property="currency.symbol" scope="session"/>&nbsp;
													</logic:present>
			                		<bean:write name="formatedInvoicePolosPrepaymentAmount"/>
			                		</logic:present></b>
			                	</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		<logic:present name="formatedInvoicePolosAfterDiscountAndTaxAndPrepayment">
			                		<logic:present name="invoice" property="currency">
													<bean:write name="invoice" property="currency.symbol" scope="session"/>&nbsp;
													</logic:present>
			                		<bean:write name="formatedInvoicePolosAfterDiscountAndTaxAndPrepayment"/>
			                		</logic:present></b>
			                	</td>
			                </tr>
			              </table>
