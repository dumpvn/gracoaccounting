...
%>
                <logic:iterate id="item" name="ITEM" type="com.mpe.financial.model.Item">
								...
								<tr bgcolor="<% out.print(bgcolor); %>">
									<td align="right"><%=++i%>.</td>
									<td><a href="#" onclick="javascript:pick('<bean:write name="item" property="code" scope="page"/>','<bean:write name="item" property="id" scope="page"/>')"><bean:write name="item" property="code" scope="page"/></a></td>
    			...
    			<tr>
    				<td align="center">
    					<table width="80%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="javascript:window.close();" value="CLOSE">
...
function pick (x,y){
  ...
  top.window.opener.document.forms[0].code.value = x;
	//top.window.opener.document.forms[0].itemId.value = y;
	top.window.opener.document.forms[0].groupId.value = y;
  //top.window.opener.document.forms[0].subaction.value = 'refresh';
