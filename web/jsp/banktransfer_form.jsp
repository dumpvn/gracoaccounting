        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/bankTransfer/save">
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%">
                  	<html:select property="fromBankAccountId">
                ...
                <logic:present name="bankAccountLst">
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%">
                  	<html:select property="toBankAccountId">
											<html:option value=""><bean:message key="page.selectBellow.title"/></html:option>
											<html:options collection="bankAccountLst" property="id" labelProperty="numberName" />
                  	</html:select>
                  </td>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="reference" size="40"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.amount.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="amount" size="25"/></td>
                </tr>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:checkbox property="isOnlineTransfer" value="Y"/>&nbsp;<bean:message key="page.yes.title"/></td>
                </tr>
                <tr> 
