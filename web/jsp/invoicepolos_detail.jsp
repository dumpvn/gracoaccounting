        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/invoicePolos/detail">
          ...
          <tr>
			...
			int i = 0;
			%>
											<logic:present name="invoice" property="invoicePolosDetails">
			                <logic:iterate id="invoiceDetail" name="invoice" property="invoicePolosDetails" type="com.mpe.financial.model.InvoicePolosDetail">
			                ...
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<bean:write name="invoice" property="formatedInvoicePolosDetailAmount"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<bean:write name="invoice" property="formatedInvoicePolosDiscountAmount"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<bean:write name="invoice" property="formatedInvoicePolosAfterDiscount"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <!--
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<bean:write name="invoice" property="formatedInvoicePolosTaxAmount"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<bean:write name="invoice" property="formatedInvoicePolosAfterDiscountAndTax"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                -->
			...
			%>
			                ...
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<bean:write name="invoice" property="formatedInvoicePolosPrepaymentAmount"/></b>
			                	</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<bean:write name="invoice" property="formatedInvoicePolosAfterDiscountAndTaxAndPrepayment"/></b>
			                	</td>
			                </tr>
			              </table>
			            </td>
          ...
          <tr>
    			...
    			<tr>
    				<td align="center">
							<input class="Button" type="button" name="edit" onclick="window.location.href=('<html:rewrite page="/invoicePolos/form.do"/>?invoiceId=<bean:write name="invoice" property="id"/>');" value="<bean:message key="page.edit.link"/>"/>&nbsp;&nbsp;
							<input class="Button" type="button" name="delete" onclick="window.location.href=('<html:rewrite page="/invoicePolos/delete.do"/>?invoiceId=<bean:write name="invoice" property="id"/>');" value="<bean:message key="page.delete.link"/>"/>&nbsp;&nbsp;
							<input class="Button" type="button" name="back" onclick="window.location.href=('<html:rewrite page="/invoicePolos/list.do"/>?start=<bean:write name="start" scope="session"/>&count=<bean:write name="count" scope="session"/>');" value="<bean:message key="page.back.link"/>"/>
    				</td>
    			</tr>
          </html:form>
        </table> 
