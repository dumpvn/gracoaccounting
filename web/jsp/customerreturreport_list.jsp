          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25>SALES RETURN</TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/customerReturReport/list">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('ReturDate')><bean:message key="page.returDate.title"/></a>&nbsp;<logic:match name="customerReturForm" property="orderBy" value="ReturDate"><logic:match name="customerReturForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerReturForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Number')><bean:message key="page.number.title"/></a>&nbsp;<logic:match name="customerReturForm" property="orderBy" value="Number"><logic:match name="customerReturForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerReturForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Customer.Id')><bean:message key="page.customer.title"/></a>&nbsp;<logic:match name="customerReturForm" property="orderBy" value="Customer.Id"><logic:match name="customerReturForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerReturForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="customerRetur" name="CUSTOMERRETUR" type="com.mpe.financial.model.CustomerRetur">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
                	<td><bean:write name="customerRetur" property="returDate" scope="page"/></td>
									<td><bean:write name="customerRetur" property="number" scope="page"/></td>
									<td>
										<logic:present name="customerRetur" property="customer">
										<bean:write name="customerRetur" property="customer.company" scope="page"/>
										</logic:present>
									</td>
									<td><bean:write name="customerRetur" property="note" scope="page"/></td>
									<td>
										...
										<bean:write name="customerRetur" property="deliveryOrder.salesOrder.discountProcent" scope="page"/>%
										</logic:present>
										</logic:present>
									</td>
									<td>
										<logic:present name="customerRetur" property="deliveryOrder">
										<logic:present name="customerRetur" property="deliveryOrder.salesOrder">
										<bean:write name="customerRetur" property="deliveryOrder.salesOrder.taxAmount" scope="page"/>%
										</logic:present>
										</logic:present>
									</td>
									<td>
                		...
                		<bean:write name="customerRetur" property="formatedAmountAfterTaxAndDiscount" scope="page"/>
									...
									<td>
										...
										<bean:write name="customerReturDetail" property="id.item.code" scope="page"/><br>
										</logic:present>
										</logic:iterate>
									</td>
									<td>
										<logic:iterate id="customerReturDetail" name="customerRetur" property="customerReturDetails" type="com.mpe.financial.model.CustomerReturDetail">
										<bean:write name="customerReturDetail" property="quantity" scope="page"/><br>
										</logic:iterate>
									</td>
									<td>
										<logic:iterate id="customerReturDetail" name="customerRetur" property="customerReturDetails" type="com.mpe.financial.model.CustomerReturDetail">
										<logic:present name="customerReturDetail" property="itemUnit">
										<bean:write name="customerReturDetail" property="itemUnit.symbol" scope="page"/><br>
										</logic:present>
										</logic:iterate>
									</td>
									<td>
										<logic:iterate id="customerReturDetail" name="customerRetur" property="customerReturDetails" type="com.mpe.financial.model.CustomerReturDetail">
										<bean:write name="customerReturDetail" property="formatedPrice" scope="page"/><br>
										</logic:iterate>
									</td>
                </tr>
                </logic:iterate>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.open('<html:rewrite page="/customerReturReport/pdfList.do"/>?number=<bean:write name="customerReturForm" property="number"/>&fromReturDate=<bean:write name="customerReturForm" property="fromReturDate"/>&toReturDate=<bean:write name="customerReturForm" property="toReturDate"/>&orderBy=<bean:write name="customerReturForm" property="orderBy"/>&ascDesc=<bean:write name="customerReturForm" property="ascDesc"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');" value="<bean:message key="page.print.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
