    			...
    			<tr>
    				<td>
    					<table width="100%">
    						...
    						<tr>
    							<td><bean:message key="page.date.title"/></td><td>:</td><td><html:text property="fromLendingDate" size="12"/>&nbsp;-&nbsp;<html:text property="toLendingDate" size="12"/>&nbsp;(dd/MM/yyyy)&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
    						</tr>
    					</table>
    				</td>
    			</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Number')><bean:message key="page.number.title"/></a>&nbsp;<logic:match name="lendingForm" property="orderBy" value="Number"><logic:match name="lendingForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="lendingForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('LendingDate')><bean:message key="page.lendingDate.title"/></a>&nbsp;<logic:match name="lendingForm" property="orderBy" value="LendingDate"><logic:match name="lendingForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="lendingForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Salesman.Id')><bean:message key="page.salesman.title"/></a>&nbsp;<logic:match name="lendingForm" property="orderBy" value="Salesman.Id"><logic:match name="lendingForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="lendingForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="lending" name="LENDING" type="com.mpe.financial.model.Lending">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
									<td><bean:write name="lending" property="number" scope="page"/></td>
									<td><bean:write name="lending" property="formatedLendingDate" scope="page"/></td>
									<td>
										<logic:present name="lending" property="salesman">
										<bean:write name="lending" property="salesman.fullName" scope="page"/>
										</logic:present>
									</td>
                  <td align="center">
										<html:link page="/lending/detail.do" paramId="lendingId" paramName="lending" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/lending/form.do" paramId="lendingId" paramName="lending" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/lending/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
