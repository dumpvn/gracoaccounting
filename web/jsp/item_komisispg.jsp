          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25>KOMISI SPG</TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/itemReport/komisiSpg">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField rowspan="2"><bean:message key="page.fullName.title"/></td>
                  <td class=titleField rowspan="2"><bean:message key="page.code.title"/></td>
                  <td class=titleField colspan="6">Sepatu</td>
                  <td class=titleField colspan="4">Semir</td>
                  <td class=titleField rowspan="2"><bean:message key="page.total.title"/></td>
                </tr>
                <tr>
                	<td class=titleField>A</td>
                	<td class=titleField>B</td>
                	<td class=titleField>C</td>
                	<td class=titleField>D</td>
                	<td class=titleField>Qty</td>
                	<td class=titleField>Komisi</td>
                	<td class=titleField>A</td>
                	<td class=titleField>B</td>
                	<td class=titleField>Qty</td>
                	<td class=titleField>Komisi</td>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.open('<html:rewrite page="/itemReport/komisiSpgPdf.do"/>?locationId=<bean:write name="itemForm" property="locationId"/>&fromDate=<bean:write name="itemForm" property="fromDate"/>&toDate=<bean:write name="itemForm" property="toDate"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');" value="<bean:message key="page.print.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
