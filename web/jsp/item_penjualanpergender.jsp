          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background="<html:rewrite page="/images/bg_title.gif"/>" height="25">PENJUALAN PER GENDER</TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/itemReport/penjualanPerGender">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <logic:iterate id="itemType" name="itemTypeLst" type="com.mpe.financial.model.ItemType">
                  <td class=titleField><bean:write name="itemType" property="code"/></td>
                  </logic:iterate>
...
%>
                <logic:iterate id="penjualanPerGender" name="penjualanPerGenderLst" type="com.mpe.financial.model.ItemPosReportPenjualanPerGender">
								<% 
									sequence++;
								...
								<tr bgcolor="<% out.print(bgcolor); %>">
									<td align="right"><%=++i%>.</td>
									<td><bean:write name="penjualanPerGender" property="merk" scope="page"/></td>
									<logic:iterate id="itemType" name="itemTypeLst" type="com.mpe.financial.model.ItemType">
									<td></td>
									</logic:iterate>
									<td></td>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.open('<html:rewrite page="/itemReport/penjualanPerGenderPdf.do"/>?itemTypeId=<bean:write name="itemForm" property="itemTypeId"/>&locationId=<bean:write name="itemForm" property="locationId"/>&fromDate=<bean:write name="itemForm" property="fromDate"/>&toDate=<bean:write name="itemForm" property="toDate"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');" value="<bean:message key="page.print.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
