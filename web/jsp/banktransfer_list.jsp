        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/bankTransfer/list">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						<tr>
    							<td><bean:message key="page.date.title"/></td><td>:</td><td><html:text property="fromTransactionDate" size="12"/>&nbsp;-&nbsp;<html:text property="fromTransactionDate" size="12"/>&nbsp;(dd/MM/yyyy)&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
    						</tr>
    					</table>
    				</td>
    			</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('FromBankAccount.Id')><bean:message key="page.fromBankAccount.title"/></a>&nbsp;<logic:match name="bankTransactionForm" property="orderBy" value="FromBankAccount.Id"><logic:match name="bankTransactionForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="bankTransactionForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('ToBankAccount.Id')><bean:message key="page.toBankAccount.title"/></a>&nbsp;<logic:match name="bankTransactionForm" property="orderBy" value="ToBankAccount.Id"><logic:match name="bankTransactionForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="bankTransactionForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('TransactionDate')><bean:message key="page.transactionDate.title"/></a>&nbsp;<logic:match name="bankTransactionForm" property="orderBy" value="TransactionDate"><logic:match name="bankTransactionForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="bankTransactionForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="bankTransfer" name="BANKTRANSFER" type="com.mpe.financial.model.BankTransaction">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
                	<td><bean:write name="bankTransfer" property="number" scope="page"/></td>
                	<td>	
                		<logic:present name="bankTransfer" property="fromBankAccount">
                		<bean:write name="bankTransfer" property="fromBankAccount.number" scope="page"/>
                		</logic:present>
                	</td>
                	<td>	
                		<logic:present name="bankTransfer" property="toBankAccount">
                		<bean:write name="bankTransfer" property="toBankAccount.number" scope="page"/>
                		</logic:present>
                	</td>
									<td><bean:write name="bankTransfer" property="transactionDate" scope="page"/></td>
									<td><bean:write name="bankTransfer" property="formatedAmount" scope="page"/>&nbsp;
										<logic:present name="bankTransfer" property="currency">
                		<bean:write name="bankTransfer" property="currency.name" scope="page"/>
                		</logic:present>
									</td>
                  <td align="center">
										<html:link page="/bankTransfer/detail.do" paramId="bankTransactionId" paramName="bankTransfer" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/bankTransfer/form.do" paramId="bankTransactionId" paramName="bankTransfer" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/bankTransfer/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
