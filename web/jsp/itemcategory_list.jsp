        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/itemCategory/list">
...
%>
                <logic:iterate id="itemCategory" name="ITEMCATEGORY" type="com.mpe.financial.model.ItemCategory">
								<% 
									sequence++;
                	...
                	<td  align=right><%=++i%>.</td>
									<td><bean:write name="itemCategory" property="name" scope="page"/></td>
									<td><bean:write name="itemCategory" property="description" scope="page"/></td>
                  <td align="center">
										<html:link page="/itemCategory/detail.do" paramId="itemCategoryId" paramName="itemCategory" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/itemCategory/form.do" paramId="itemCategoryId" paramName="itemCategory" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/itemCategory/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
