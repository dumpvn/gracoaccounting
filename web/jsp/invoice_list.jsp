                ...
                <logic:iterate id="invoice" name="INVOICE" type="com.mpe.financial.model.Invoice">
                	...
                	<td>	
                		...
                		<bean:write name="invoice" property="customer.company" scope="page"/>
									...
									<td><bean:write name="invoice" property="formatedInvoiceAfterDiscountAndTaxAndPrepayment" scope="page"/>&nbsp;
                  ...
                  <td align="center">
										<html:link page="/invoice/detail.do" paramId="invoiceId" paramName="invoice" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/invoice/form.do" paramId="invoiceId" paramName="invoice" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<a href="#" onclick="window.open('<html:rewrite page="/invoice/printed.do"/>?invoiceId=<bean:write name="invoice" property="id"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');"><html:img page="/images/print.gif" border="0" alt="Print"/></a>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/invoice/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
