...
%>
                <logic:iterate id="item" name="ITEM" type="com.mpe.financial.model.Item">
								...
								<tr bgcolor="<% out.print(bgcolor); %>">
									<td align="right"><%=++i%>.</td>
									<td><a href="#" onclick="javascript:pick('<bean:write name="item" property="code" scope="page"/>')"><bean:write name="item" property="code" scope="page"/></a></td>
...
function pick (x){
  ...
  top.window.opener.document.forms[0].itemCode.value = x;
