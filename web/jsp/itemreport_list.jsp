        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/itemReport/list">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						<logic:present name="itemCategoryLst">
    						<tr> 
...
%>
                <logic:iterate id="item" name="ITEM" type="com.mpe.financial.model.Item">
								...
								<tr bgcolor="<% out.print(bgcolor); %>">
									...
									<td><bean:write name="item" property="formatedPrice" scope="page"/></td>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.open('<html:rewrite page="/itemReport/pdfList.do"/>?code=<bean:write name="itemForm" property="code"/>&name=<bean:write name="itemForm" property="name"/>&orderBy=<bean:write name="itemForm" property="orderBy"/>&ascDesc=<bean:write name="itemForm" property="ascDesc"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');" value="<bean:message key="page.print.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
