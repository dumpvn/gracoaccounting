        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/vendor/communicationSave">
          ...
          <tr>
			...
			%>
											<logic:present name="vendorCommunicationLst">
			                <logic:iterate id="vendorCommunication" name="vendorCommunicationLst" type="com.mpe.financial.model.VendorsCommunication">
			                <tr bgcolor="#FFFFFF" align=center>
			                	<td><%=++i%>.</td>
												<td>
													<logic:present name="vendorCommunication" property="id.contactPerson">
													<bean:write name="vendorCommunication" property="id.contactPerson" scope="page"/>
													</logic:present>
												</td>
												<td><bean:write name="vendorCommunication" property="title" scope="page"/></td>
												<td><bean:write name="vendorCommunication" property="officePhone" scope="page"/></td>
												<td><bean:write name="vendorCommunication" property="mobile" scope="page"/></td>
												<td><bean:write name="vendorCommunication" property="fax" scope="page"/></td>
			                  <td align="center">
													<a href="<html:rewrite page="/vendor/communicationForm.do"/>?vendorId=<bean:write name="vendorsForm" property="vendorId"/>&contactPerson=<bean:write name="vendorCommunication" property="id.contactPerson"/>"><html:img page="/images/edit.gif" border="0" alt="Edit"/></a>&nbsp;
			                  	<a href="<html:rewrite page="/vendor/communicationForm.do"/>?vendorId=<bean:write name="vendorsForm" property="vendorId"/>&contactPerson=<bean:write name="vendorCommunication" property="id.contactPerson"/>&subaction=REMOVEDETAIL&caller=/vendor/addressForm.do"><html:img page="/images/trash.gif" border="0" alt="Remove"/></a>
			                  </td>
			                </tr>
			                </logic:iterate>
			                </logic:present>
