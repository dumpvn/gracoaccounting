        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/stockOpname/save">
					...
					<html:hidden property="stockOpnameDetailCurrencyId"/>
          <tr>
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <logic:equal name="stockOpnameForm" property="stockOpnameId" value="0">
                <tr> 
                ...
                <logic:greaterThan name="stockOpnameForm" property="stockOpnameId" value="0">
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.number.title"/></td>
                  <td width="5%" align="center">:</td>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="stockOpnameDate" size="12"/>&nbsp;(dd/MM/yyyy)</td>
                </tr>
                ...
                <logic:present name="stockOpnameTypeLst">
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.stockOpnameType.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%">
                  	<html:select property="stockOpnameTypeId">
											<html:option value=""><bean:message key="page.selectBellow.title"/></html:option>
											<html:options collection="stockOpnameTypeLst" property="id" labelProperty="name" />
                  	</html:select>
                  </td>
                </tr>
                </logic:present>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:textarea property="note" cols="50" rows="4"/></td>
                </tr>
          ...
          <tr>
			            ...
			            <td align="center"> 
			              <table border="0" cellspacing=1 cellpadding=0 bgcolor="#cccccc" width="100%">
			                <tr align="center"> 
			                  ...
			                  <td class=titleField><bean:message key="page.currentQuantity.title"/></td>
			...
			%>
											<logic:present name="stockOpnameDetailLst">
			                <logic:iterate id="stockOpnameDetail" name="stockOpnameDetailLst" type="com.mpe.financial.model.StockOpnameDetail">
			                <tr bgcolor="#FFFFFF" align=center>
			                	<td><%=++i%>.</td>
												<td>
													<logic:present name="stockOpnameDetail" property="id.item">
													<bean:write name="stockOpnameDetail" property="id.item.code" scope="page"/>&nbsp;
												...
												<td><logic:present name="stockOpnameDetail" property="itemUnit">
			                  ...
			                  <td align="center">
													<a href="<html:rewrite page="/stockOpname/form.do"/>?stockOpnameId=<bean:write name="stockOpnameForm" property="stockOpnameId"/>&itemId=<bean:write name="stockOpnameDetail" property="id.item.id"/>"><html:img page="/images/edit.gif" border="0" alt="Edit"/></a>&nbsp;
			                  	<a href="<html:rewrite page="/stockOpname/form.do"/>?stockOpnameId=<bean:write name="stockOpnameForm" property="stockOpnameId"/>&itemId=<bean:write name="stockOpnameDetail" property="id.item.id"/>&subaction=REMOVESTOCKOPNAMEDETAIL&caller=/stockOpname/form.do"><html:img page="/images/trash.gif" border="0" alt="Remove"/></a>
			                  </td>
			                </tr>
			                </logic:iterate>
			                </logic:present>
			                ...
			                <tr>
			                	...
			                	<td><html:text property="currentQuantity" size="20"/></td>
			                	<td>
			                	...
			                	<td><html:text property="price" readonly="true" size="20"/></td>
			                	<td>&nbsp;</td>
