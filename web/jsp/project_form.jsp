            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="65%"><html:text property="code" size="20"/></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="startDate" size="12"/>&nbsp;(dd/MM/yyyy)</td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.endDate.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="endDate" size="12"/>&nbsp;(dd/MM/yyyy)</td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.status.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%">
                  	<html:radio property="status" value="OPEN"/>&nbsp;Open&nbsp;
                  	<html:radio property="status" value="CLOSE"/>&nbsp;Close&nbsp;
                  	<html:radio property="status" value="CANCEL"/>&nbsp;Cancel&nbsp;
                  </td>
                </tr>
								<tr> 
                  <td width="30%" align="right"><bean:message key="page.description.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:textarea property="description" cols="40" rows="10"/></td>
                </tr>
              </table>
            </td>
          </tr>
