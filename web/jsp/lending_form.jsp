      ...
      <TABLE height=50 cellSpacing=1 cellPadding=1 border=0 width="100%" valign="top"><BR><BR>
        ...
        <TR>
          ...
          <tr>
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <logic:equal name="lendingForm" property="lendingId" value="0">
                <tr> 
                ...
                <logic:greaterThan name="lendingForm" property="lendingId" value="0">
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.number.title"/></td>
                  <td width="5%" align="center">:</td>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="lendingDate" size="12"/>&nbsp;(dd/MM/yyyy)</td>
                </tr>
                <tr> 
          ...
          <tr>
			...
			%>
											<logic:present name="lendingDetailLst">
			                <logic:iterate id="lendingDetail" name="lendingDetailLst" type="com.mpe.financial.model.LendingDetail">
			                <tr bgcolor="#FFFFFF" align=center>
			                	<td><%=++i%>.</td>
												<td>
													<logic:present name="lendingDetail" property="id.item">
													<bean:write name="lendingDetail" property="id.item.code" scope="page"/>&nbsp;
												...
												<td><logic:present name="lendingDetail" property="itemUnit">
			                  ...
			                  <td align="center">
													<a href="<html:rewrite page="/lending/form.do"/>?lendingId=<bean:write name="lendingForm" property="lendingId"/>&itemId=<bean:write name="lendingDetail" property="id.item.id"/>"><html:img page="/images/edit.gif" border="0" alt="Edit"/></a>&nbsp;
			                  	<a href="<html:rewrite page="/lending/form.do"/>?lendingId=<bean:write name="lendingForm" property="lendingId"/>&itemId=<bean:write name="lendingDetail" property="id.item.id"/>&subaction=REMOVEDETAIL&caller=/lending/form.do"><html:img page="/images/trash.gif" border="0" alt="Remove"/></a>
			                  </td>
			                </tr>
			                </logic:iterate>
			                </logic:present>
			                ...
			                <tr>
			                	...
			                	<td><html:text property="lendingQuantity" size="20"/></td>
			                	...
			                	<td><html:text property="itemDescription" size="50"/></td>
