        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/vendorBill/list">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						...
    						<tr>
    							<td><bean:message key="page.date.title"/></td><td>:</td><td><html:text property="fromBillDate" size="12"/>&nbsp;-&nbsp;<html:text property="toBillDate" size="12"/>&nbsp;(dd/MM/yyyy)&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
    						</tr>
    					</table>
    				</td>
    			</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Number')><bean:message key="page.number.title"/></a>&nbsp;<logic:match name="vendorBillForm" property="orderBy" value="Number"><logic:match name="vendorBillForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="vendorBillForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('BillDate')><bean:message key="page.billDate.title"/></a>&nbsp;<logic:match name="vendorBillForm" property="orderBy" value="BillDate"><logic:match name="vendorBillForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="vendorBillForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('BillDue')><bean:message key="page.billDue.title"/></a>&nbsp;<logic:match name="vendorBillForm" property="orderBy" value="BillDue"><logic:match name="vendorBillForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="vendorBillForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Receiving.Id')><bean:message key="page.receiving.title"/></a>&nbsp;<logic:match name="vendorBillForm" property="orderBy" value="Receiving.Id"><logic:match name="vendorBillForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="vendorBillForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Vendor.Id')><bean:message key="page.vendor.title"/></a>&nbsp;<logic:match name="vendorBillForm" property="orderBy" value="Vendor.Id"><logic:match name="vendorBillForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="vendorBillForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><bean:message key="page.amount.title"/></td>
                  <td class=titleField><a href=javascript:sort('PaymentToVendorStatus')><bean:message key="page.paymentToVendorStatus.title"/></a>&nbsp;<logic:match name="vendorBillForm" property="orderBy" value="PaymentToVendorStatus"><logic:match name="vendorBillForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="vendorBillForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="vendorBill" name="VENDORBILL" type="com.mpe.financial.model.VendorBill">
								<% 
									sequence++;
                	...
                	<td>	
                		...
                		<bean:write name="vendorBill" property="receiving.number" scope="page"/>
                		</logic:present>
                	</td>
									<td>	
                		...
                		<bean:write name="vendorBill" property="vendor.company" scope="page"/>
									...
									<td><bean:write name="vendorBill" property="formatedVendorBillAfterDiscountAndTaxAndPrepayment" scope="page"/>&nbsp;
										<logic:present name="vendorBill" property="currency">
                		<bean:write name="vendorBill" property="currency.name" scope="page"/>
                		</logic:present>
									</td>
									<td><bean:write name="vendorBill" property="paymentToVendorStatus" scope="page"/></td>
                  <td align="center">
										<html:link page="/vendorBill/detail.do" paramId="vendorBillId" paramName="vendorBill" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/vendorBill/form.do" paramId="vendorBillId" paramName="vendorBill" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/vendorBill/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
