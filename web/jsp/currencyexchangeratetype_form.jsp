        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/currencyExchangeRateType/save">
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="65%">
                  	<html:radio property="type" value="Corporate"/>&nbsp;<bean:message key="page.corporate.title"/>&nbsp;&nbsp;
                  	<html:radio property="type" value="Fluctuation"/>&nbsp;<bean:message key="page.fluctuation.title"/>
                  </td>
                </tr>
                <tr> 
