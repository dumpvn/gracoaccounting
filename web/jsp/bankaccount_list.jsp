        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/bankAccount/list">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						<tr>
    							<td><bean:message key="page.name.title"/> : <html:text property="name" size="20"/>&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
    						</tr>
    					</table>
    				</td>
    			</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Bank.Id')><bean:message key="page.bank.title"/></a>&nbsp;<logic:match name="bankAccountForm" property="orderBy" value="Bank.Id"><logic:match name="bankAccountForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="bankAccountForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Name')><bean:message key="page.name.title"/></a>&nbsp;<logic:match name="bankAccountForm" property="orderBy" value="Name"><logic:match name="bankAccountForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="bankAccountForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Number')><bean:message key="page.number.title"/></a>&nbsp;<logic:match name="bankAccountForm" property="orderBy" value="Number"><logic:match name="bankAccountForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="bankAccountForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="bankAccount" name="BANKACCOUNT" type="com.mpe.financial.model.BankAccount">
								<% 
									sequence++;
                	...
                	<td>	
                		...
                		<bean:write name="bankAccount" property="bank.name" scope="page"/>
                		</logic:present>
                	</td>
									<td><bean:write name="bankAccount" property="name" scope="page"/></td>
									<td><bean:write name="bankAccount" property="number" scope="page"/></td>
                  <td align="center">
										<html:link page="/bankAccount/detail.do" paramId="bankAccountId" paramName="bankAccount" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/bankAccount/form.do" paramId="bankAccountId" paramName="bankAccount" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/bankAccount/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
