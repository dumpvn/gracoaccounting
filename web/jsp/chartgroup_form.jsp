        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/chartGroup/save">
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="65%">
                  	<html:select property="groups" onchange="this.form.subaction.value='form';this.form.submit();">
                  		<html:option value=""><bean:message key="page.selectBellow.title"/></html:option>
											<html:option value="Asset"><bean:message key="page.asset.title"/></html:option>
											<html:option value="Liability"><bean:message key="page.liability.title"/></html:option>
											<html:option value="Equity"><bean:message key="page.equity.title"/></html:option>
											<html:option value="Revenue"><bean:message key="page.revenue.title"/></html:option>
											<html:option value="Expense"><bean:message key="page.expense.title"/></html:option>
                  	</html:select>
                  </td>
                </tr>
                <logic:equal name="chartGroupForm" property="chartGroupId" value="0">
                <tr> 
                ...
                <logic:greaterThan name="chartGroupForm" property="chartGroupId" value="0">
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.name.title"/></td>
                  <td width="5%">:</td>
