        ...
        <TR>
          ...
          <tr>
			...
			%>
			                ...
			                <logic:iterate id="invoiceDetail" name="invoiceDetailLst" type="com.mpe.financial.model.InvoiceDetail">
			                ...
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<logic:present name="formatedInvoiceDetailAmount"><bean:write name="formatedInvoiceDetailAmount"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<logic:present name="formatedInvoiceDiscountAmount"><bean:write name="formatedInvoiceDiscountAmount"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<logic:present name="formatedInvoiceAfterDiscountAmount"><bean:write name="formatedInvoiceAfterDiscountAmount"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<logic:present name="formatedInvoiceTaxAmount"><bean:write name="formatedInvoiceTaxAmount"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<logic:present name="formatedInvoiceAfterDiscountAndTax"><bean:write name="formatedInvoiceAfterDiscountAndTax"/></logic:present></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			              </table>
          ...
          <tr>
			...
			%>
			                ...
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		<logic:present name="formatedInvoicePrepaymentAmount">
			                		<!--
			                		<logic:present name="invoice" property="currency">
													<bean:write name="invoice" property="currency.symbol" scope="session"/>&nbsp;
													</logic:present>
													-->
			                		<bean:write name="formatedInvoicePrepaymentAmount"/>
			                		</logic:present></b>
			                	</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		<logic:present name="formatedInvoiceAfterDiscountAndTaxAndPrepayment">
			                		<!--
			                		<logic:present name="invoice" property="currency">
													<bean:write name="invoice" property="currency.symbol" scope="session"/>&nbsp;
													</logic:present>
													-->
			                		<bean:write name="formatedInvoiceAfterDiscountAndTaxAndPrepayment"/>
			                		</logic:present></b>
			                	</td>
			                </tr>
			              </table>
