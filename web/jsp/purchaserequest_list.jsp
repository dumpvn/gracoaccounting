        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/purchaseRequest/list">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						...
    						<tr>
    							<td><bean:message key="page.date.title"/></td><td>:</td><td><html:text property="fromRequestDate" size="12"/>&nbsp;-&nbsp;<html:text property="toRequestDate" size="12"/>&nbsp;(dd/MM/yyyy)&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
    						</tr>
    					</table>
    				</td>
    			</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Number')><bean:message key="page.number.title"/></a>&nbsp;<logic:match name="purchaseRequestForm" property="orderBy" value="Number"><logic:match name="purchaseRequestForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="purchaseRequestForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('RequestDate')><bean:message key="page.requestDate.title"/></a>&nbsp;<logic:match name="purchaseRequestForm" property="orderBy" value="RequestDate"><logic:match name="purchaseRequestForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="purchaseRequestForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Vendor.Id')><bean:message key="page.vendor.title"/></a>&nbsp;<logic:match name="purchaseRequestForm" property="orderBy" value="Vendor.Id"><logic:match name="purchaseRequestForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="purchaseRequestForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="purchaseRequest" name="PURCHASEREQUEST" type="com.mpe.financial.model.PurchaseRequest">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
									<td><bean:write name="purchaseRequest" property="number" scope="page"/></td>
									<td><bean:write name="purchaseRequest" property="formatedRequestDate" scope="page"/></td>
									<td>
										<logic:present name="purchaseRequest" property="vendor">
										<bean:write name="purchaseRequest" property="vendor.company" scope="page"/>
										</logic:present>
									</td>
                  <td align="center">
										<html:link page="/purchaseRequest/detail.do" paramId="purchaseRequestId" paramName="purchaseRequest" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/purchaseRequest/form.do" paramId="purchaseRequestId" paramName="purchaseRequest" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<a href="#" onclick="window.open('<html:rewrite page="/purchaseRequest/printed.do"/>?purchaseRequestId=<bean:write name="purchaseRequest" property="id"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');"><html:img page="/images/print.gif" border="0" alt="Print"/></a>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/purchaseRequest/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
