        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/deliveryOrderBonKuning/list">
...
%>
                <logic:iterate id="deliveryOrder" name="DELIVERYORDER" type="com.mpe.financial.model.DeliveryOrder">
                  ...
                  <td align="center">
										<html:link page="/deliveryOrderBonKuning/detail.do" paramId="deliveryOrderId" paramName="deliveryOrder" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/deliveryOrderBonKuning/form.do" paramId="deliveryOrderId" paramName="deliveryOrder" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/deliveryOrderBonKuning/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
