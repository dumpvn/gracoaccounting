        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/salesOrderProject/list">
...
%>
                <logic:iterate id="salesOrder" name="SALESORDER" type="com.mpe.financial.model.SalesOrder">
                  ...
                  <td align="center">
										<html:link page="/salesOrderProject/detail.do" paramId="salesOrderId" paramName="salesOrder" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/salesOrderProject/form.do" paramId="salesOrderId" paramName="salesOrder" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
                  	<a href="#" onclick="window.open('<html:rewrite page="/salesOrderProject/printed.do"/>?salesOrderId=<bean:write name="salesOrder" property="id"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');"><html:img page="/images/print.gif" border="0" alt="Print"/></a>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/salesOrderProject/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
