        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/item/save" enctype="multipart/form-data">
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%">
                  	<html:radio property="type" value="PRODUCT"/>&nbsp;Product&nbsp;&nbsp;
                  	<html:radio property="type" value="SERVICE"/>&nbsp;Service&nbsp;&nbsp;
                  	<html:radio property="type" value="FIXASSET"/>&nbsp;Fix Asset&nbsp;&nbsp;
                  </td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.code.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="code" size="25"/></td>
                </tr>
								<tr> 
                  <td width="30%" align="right"><bean:message key="page.plu.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="plu" size="25"/></td>
                </tr>
								<tr> 
                  <td width="30%" align="right"><bean:message key="page.barcode.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="barcode" size="25"/></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:textarea property="description" cols="60" rows="3"/></td>
                </tr>
                <tr> 
                  <td colspan="3">&nbsp;</td>
                </tr>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="minimumStock" size="15"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.maximumStock.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="maximumStock" size="15"/></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%">
                  	<html:select property="costPriceAccountId">
											<html:option value=""><bean:message key="page.selectBellow.title"/></html:option>
											<html:options collection="chartOfAccountLst" property="id" labelProperty="numberName" />
                  	</html:select>
                  </td>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="costPrice" size="15"/></td>
                </tr>
                <tr> 
