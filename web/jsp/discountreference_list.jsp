        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/discountReference/list">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						<tr>
    							<td><bean:message key="page.discountType.title"/></td><td>:</td><td><html:text property="discountType" size="30"/>&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
    						</tr>
    					</table>
    				</td>
    			</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('DiscountType')><bean:message key="page.discountType.title"/></a>&nbsp;<logic:match name="discountReferenceForm" property="orderBy" value="DiscountType"><logic:match name="discountReferenceForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="discountReferenceForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Amount')><bean:message key="page.amount.title"/></a>&nbsp;<logic:match name="discountReferenceForm" property="orderBy" value="Amount"><logic:match name="discountReferenceForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="discountReferenceForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="discountReference" name="DISCOUNTREFERENCE" type="com.mpe.financial.model.DiscountReference">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
									<td><bean:write name="discountReference" property="discountType" scope="page"/></td>
									<td><bean:write name="discountReference" property="amount" scope="page"/>%</td>
                  <td align="center">
										<html:link page="/discountReference/detail.do" paramId="discountReferenceId" paramName="discountReference" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/discountReference/form.do" paramId="discountReferenceId" paramName="discountReference" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/discountReference/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
