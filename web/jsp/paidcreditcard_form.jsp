        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/paidCreditCard/save">
          ...
          <tr> 
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.paidDate.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="paidDate" size="12"/>&nbsp;(dd/MM/yyyy)</td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.creditCard.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="creditCardNumber" size="16" readonly="true"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right">Adm</td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="adm" size="12" readonly="true"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.amount.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="amount" size="20" readonly="true"/></td>
                </tr>
              </table>
            </td>
          </tr>
