        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/stockOpname/list">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Warehouse.Id')><bean:message key="page.warehouse.title"/></a>&nbsp;<logic:match name="stockOpnameForm" property="orderBy" value="Warehouse.Id"><logic:match name="stockOpnameForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="stockOpnameForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                ...
                <logic:iterate id="stockOpname" name="STOCKOPNAME" type="com.mpe.financial.model.StockOpname">
                	...
                	<td align="right"><%=++i%>.</td>
									...
									<td>
										...
										<bean:write name="stockOpname" property="warehouse.name" scope="page"/>
										</logic:present>
									</td>
									<td><bean:write name="stockOpname" property="formatedStockOpnameDetailAmount" scope="page"/>&nbsp;
										<logic:present name="stockOpname" property="currency">
										<bean:write name="stockOpname" property="currency.name" scope="page"/>
										</logic:present>
									</td>
                  <td align="center">
										<html:link page="/stockOpname/detail.do" paramId="stockOpnameId" paramName="stockOpname" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/stockOpname/form.do" paramId="stockOpnameId" paramName="stockOpname" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/stockOpname/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
