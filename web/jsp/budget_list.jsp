            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Year')><bean:message key="page.year.title"/></a>&nbsp;<logic:match name="budgetForm" property="orderBy" value="Year"><logic:match name="budgetForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="budgetForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Department.Id')><bean:message key="page.department.title"/></a>&nbsp;<logic:match name="budgetForm" property="orderBy" value="Department.Id"><logic:match name="budgetForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="budgetForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Description')><bean:message key="page.description.title"/></a>&nbsp;<logic:match name="budgetForm" property="orderBy" value="Description"><logic:match name="budgetForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="budgetForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="budget" name="BUDGET" type="com.mpe.financial.model.Budget">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
									<td><bean:write name="budget" property="year" scope="page"/></td>
									<td>
										<logic:present name="budget" property="department">
										<bean:write name="budget" property="department.name" scope="page"/>
										</logic:present>
									</td>
									<td><bean:write name="budget" property="description" scope="page"/></td>
                  <td align="center">
										<html:link page="/budget/detail.do" paramId="budgetId" paramName="budget" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/budget/form.do" paramId="budgetId" paramName="budget" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
