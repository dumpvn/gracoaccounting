        ...
        <TR>
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="65%" class="DataForm"><bean:write name="role" property="roleName" scope="request"/></td>
                </tr>
                <tr> 
                  <td width="30%" class="DataForm"><bean:message key="page.description.title"/></td>
                  <td width="5%" class="DataForm">:</td>
                  <td width="65%" class="DataForm"><bean:write name="role" property="description" scope="request"/></td>
                </tr>
              </table>
            </td>
          </tr>
          <tr>
              ...
              <input class="Button" type="button" name="edit" onclick="window.location.href=('<html:rewrite page="/role/form.do"/>?roleId=<bean:write name="role" property="id"/>');" value="<bean:message key="page.edit.link"/>"/>&nbsp;&nbsp;
							<input class="Button" type="button" name="delete" onclick="window.location.href=('<html:rewrite page="/role/delete.do"/>?roleId=<bean:write name="role" property="id"/>');" value="<bean:message key="page.delete.link"/>"/>&nbsp;&nbsp;
