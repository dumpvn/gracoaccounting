          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25>RECAPITULATION STOCK OFFICE</TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/inventoryReport/rekapMutationStockOfficeList">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField colspan="2"><bean:message key="page.receiving.title"/></td>
                  <td class=titleField colspan="2"><bean:message key="page.returToVendor.title"/></td>
                  <td class=titleField colspan="2"><bean:message key="page.deliveryOrder.title"/></td>
