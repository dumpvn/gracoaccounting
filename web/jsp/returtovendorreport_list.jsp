          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25>PURCHASE RETURN</TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/returToVendorReport/list">
                ...
                <logic:iterate id="returToVendor" name="RETURTOVENDOR" type="com.mpe.financial.model.ReturToVendor">
                	...
                	<td align="right"><%=++i%>.</td>
									...
									<td>
										...
										<bean:write name="returToVendor" property="receiving.purchaseOrder.taxAmount" scope="page"/>%
										</logic:present>
										</logic:present>
									</td>
									<td>
										<logic:present name="returToVendor" property="receiving">
										<logic:present name="returToVendor" property="receiving.purchaseOrder">
										<bean:write name="returToVendor" property="receiving.purchaseOrder.discountProcent" scope="page"/>%
										</logic:present>
										</logic:present>
									</td>
									<td>
                		...
                		<bean:write name="returToVendor" property="formatedAmountAfterTaxAndDiscount" scope="page"/>
									...
									<td>
										...
										<bean:write name="returToVendorDetail" property="id.item.code" scope="page"/><br>
										</logic:iterate>
									</td>
									<td>
										<logic:iterate id="returToVendorDetail" name="returToVendor" property="returToVendorDetails" type="com.mpe.financial.model.ReturToVendorDetail">
										<bean:write name="returToVendorDetail" property="quantity" scope="page"/><br>
										</logic:iterate>
									</td>
									<td>
										<logic:iterate id="returToVendorDetail" name="returToVendor" property="returToVendorDetails" type="com.mpe.financial.model.ReturToVendorDetail">
										<bean:write name="returToVendorDetail" property="itemUnit.symbol" scope="page"/><br>
										</logic:iterate>
									</td>
									<td>
										<logic:iterate id="returToVendorDetail" name="returToVendor" property="returToVendorDetails" type="com.mpe.financial.model.ReturToVendorDetail">
										<logic:present name="returToVendorDetail" property="currency">
										<bean:write name="returToVendorDetail" property="currency.symbol"/>&nbsp;
										</logic:present>
										<bean:write name="returToVendorDetail" property="formatedPrice" scope="page"/><br>
										</logic:iterate>
									</td>
                </tr>
                </logic:iterate>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.open('<html:rewrite page="/returToVendorReport/pdfList.do"/>?number=<bean:write name="returToVendorForm" property="number"/>&fromReturDate=<bean:write name="returToVendorForm" property="fromReturDate"/>&toReturDate=<bean:write name="returToVendorForm" property="toReturDate"/>&orderBy=<bean:write name="returToVendorForm" property="orderBy"/>&ascDesc=<bean:write name="returToVendorForm" property="ascDesc"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');" value="<bean:message key="page.print.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
