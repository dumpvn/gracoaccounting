        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/discountReference/save">
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                ...
                <tr> 
                  ...
                  <td width="5%">:</td>
                  <td width="65%">
                  	<html:select property="discountType">
											<html:option value="SO">SO</html:option>
											<html:option value="SO_PROJECT">SO-PROJECT</html:option>
                  	</html:select>
                  </td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="5%">:</td>
                  <td width="65%"><html:text property="validFrom" size="12"/>&nbsp;-&nbsp;<html:text property="validTo" size="12"/></td>
                </tr>
                <tr> 
