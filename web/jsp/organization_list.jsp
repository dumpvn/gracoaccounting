...
%>
                <logic:iterate id="organization" name="ORGANIZATION" type="com.mpe.financial.model.Organization">
                	...
                	<td align="right"><%=++i%>.</td>
									<td><bean:write name="organization" property="name" scope="page"/></td>
									<td><bean:write name="organization" property="npwp" scope="page"/></td>
									<td>
                  ...
                  <td align="center">
										<html:link page="/organization/detail.do" paramId="organizationId" paramName="organization" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/organization/form.do" paramId="organizationId" paramName="organization" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<html:link page="/organizationSetup/form.do" paramId="organizationId" paramName="organization" paramProperty="id"><html:img page="/images/config.gif" border="0" alt="Setup"/></html:link>&nbsp;
										<html:link page="/runningNumber/form.do" paramId="organizationId" paramName="organization" paramProperty="id"><html:img page="/images/record.gif" border="0" alt="Auto Number"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
