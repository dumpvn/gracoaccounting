            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="location" size="30"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.dimension.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="dimension" size="30"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.personCapacity.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="personCapacity" size="3"/></td>
                </tr>
                <!--
								<tr> 
