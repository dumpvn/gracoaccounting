        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/customerPrepayment/list">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Number')><bean:message key="page.number.title"/></a>&nbsp;<logic:match name="customerPrepaymentForm" property="orderBy" value="Number"><logic:match name="customerPrepaymentForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerPrepaymentForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('PrepaymentDate')><bean:message key="page.prepaymentDate.title"/></a>&nbsp;<logic:match name="customerPrepaymentForm" property="orderBy" value="PrepaymentDate"><logic:match name="customerPrepaymentForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerPrepaymentForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('SalesOrder.Id')><bean:message key="page.salesOrder.title"/></a>&nbsp;<logic:match name="customerPrepaymentForm" property="orderBy" value="SalesOrder.Id"><logic:match name="customerPrepaymentForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerPrepaymentForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Customer.Id')><bean:message key="page.customer.title"/></a>&nbsp;<logic:match name="customerPrepaymentForm" property="orderBy" value="Customer.Id"><logic:match name="customerPrepaymentForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerPrepaymentForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('BankAccount.Id')><bean:message key="page.bankAccount.title"/></a>&nbsp;<logic:match name="customerPrepaymentForm" property="orderBy" value="BankAccount.Id"><logic:match name="customerPrepaymentForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerPrepaymentForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Amount')><bean:message key="page.amount.title"/></a>&nbsp;<logic:match name="customerPrepaymentForm" property="orderBy" value="Amount"><logic:match name="customerPrepaymentForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerPrepaymentForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('InvoiceStatus')><bean:message key="page.invoiceStatus.title"/></a>&nbsp;<logic:match name="customerPrepaymentForm" property="orderBy" value="InvoiceStatus"><logic:match name="customerPrepaymentForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerPrepaymentForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="customerPrepayment" name="CUSTOMERPREPAYMENT" type="com.mpe.financial.model.CustomerPrepayment">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
                	<td><bean:write name="customerPrepayment" property="number" scope="page"/></td>
                	<td><bean:write name="customerPrepayment" property="prepaymentDate" scope="page"/></td>
                	<td>	
                		<logic:present name="customerPrepayment" property="salesOrder">
                		<bean:write name="customerPrepayment" property="salesOrder.number" scope="page"/>
                		</logic:present>
                	</td>
									<td>	
                		<logic:present name="customerPrepayment" property="customer">
                		<bean:write name="customerPrepayment" property="customer.company" scope="page"/>
                		</logic:present>
                	</td>
                	<td>	
                		<logic:present name="customerPrepayment" property="bankAccount">
                		<bean:write name="customerPrepayment" property="bankAccount.number" scope="page"/>
                		</logic:present>
                	</td>
									<td><bean:write name="customerPrepayment" property="formatedAmount" scope="page"/>&nbsp;
										<logic:present name="customerPrepayment" property="currency">
                		<bean:write name="customerPrepayment" property="currency.name" scope="page"/>
                		</logic:present>
									</td>
									<td><bean:write name="customerPrepayment" property="invoiceStatus" scope="page"/></td>
                  <td align="center">
										<html:link page="/customerPrepayment/detail.do" paramId="customerPrepaymentId" paramName="customerPrepayment" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/customerPrepayment/form.do" paramId="customerPrepaymentId" paramName="customerPrepayment" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/customerPrepayment/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
