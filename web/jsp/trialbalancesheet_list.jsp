          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25><bean:message key="page.trialBalanceTitle.title"/></TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/trialBalanceSheet/list">
...
%>
                ...
                <logic:iterate id="asset" name="ASSET" type="com.mpe.financial.model.ProfitLossReport">
                	...
                	<td align="right"><%=++i%>.</td>
                	<td><bean:write name="asset" property="number" scope="page"/></td>
									<td><bean:write name="asset" property="name" scope="page"/></td>
									<td><bean:write name="asset" property="type" scope="page"/></td>
									<td><bean:write name="asset" property="groups" scope="page"/></td>
									<td><bean:write name="asset" property="debit" scope="page"/></td>
									<td align="right"><bean:write name="asset" property="formatedAmount" scope="page"/></td>
                </tr>
                </logic:iterate>
                </logic:present>
                <tr bgcolor="#FFFFFF">
                	<td colspan="6"><b><bean:message key="page.asset.title"/>&nbsp;</b></td>
                ...
                <logic:iterate id="liability" name="LIABILITY" type="com.mpe.financial.model.ProfitLossReport">
								...
								<tr bgcolor="<% out.print(bgcolor); %>">
                	<td align="right"><%=++i%>.</td>
                	<td><bean:write name="liability" property="number" scope="page"/></td>
									<td><bean:write name="liability" property="name" scope="page"/></td>
									<td><bean:write name="liability" property="type" scope="page"/></td>
									<td><bean:write name="liability" property="groups" scope="page"/></td>
									<td><bean:write name="liability" property="debit" scope="page"/></td>
									<td align="right"><bean:write name="liability" property="formatedAmount" scope="page"/></td>
                </tr>
                </logic:iterate>
                </logic:present>
                <tr bgcolor="#FFFFFF">
                	<td colspan="6"><b><bean:message key="page.liability.title"/>&nbsp;</b></td>
                ...
                <logic:iterate id="equity" name="EQUITY" type="com.mpe.financial.model.ProfitLossReport">
								...
								<tr bgcolor="<% out.print(bgcolor); %>">
                	<td align="right"><%=++i%>.</td>
                	<td><bean:write name="equity" property="number" scope="page"/></td>
									<td><bean:write name="equity" property="name" scope="page"/></td>
									<td><bean:write name="equity" property="type" scope="page"/></td>
									<td><bean:write name="equity" property="groups" scope="page"/></td>
									<td><bean:write name="equity" property="debit" scope="page"/></td>
									<td align="right"><bean:write name="equity" property="formatedAmount" scope="page"/></td>
                </tr>
                </logic:iterate>
                </logic:present>
                <tr bgcolor="#FFFFFF">
                	<td colspan="6"><b><bean:message key="page.equity.title"/>&nbsp;</b></td>
