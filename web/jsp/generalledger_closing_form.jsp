        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/generalLedger/closingConfirm">						        			
          <tr>
    				<td>
    					<table width="100%">
    						<tr valign="top"><td>&nbsp;</td></tr>
    				...
    				<td>
    					<table width="100%">
    						<tr><td align="center"><b>
    							This action will be closing general ledger this periode (<bean:write name="generalLedgerForm" property="setupDate"/>&nbsp;-&nbsp;<bean:write name="generalLedgerForm" property="fromDate"/>)!<br>
    							And start new periode at <bean:write name="generalLedgerForm" property="toDate"/>.</b>
    						</td></tr>
    					</table>
    				</td>
    			</tr>
