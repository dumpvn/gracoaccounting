          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25><bean:message key="page.warehouseTitle.title"/></TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/warehouse/list">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						...
    						<tr>
    							<td><bean:message key="page.location.title"/></td><td>:</td><td>
...
%>
                <logic:iterate id="warehouse" name="WAREHOUSE" type="com.mpe.financial.model.Warehouse">
								<% 
									sequence++;
                	...
                	<td  align=right><%=++i%>.</td>
									<td><bean:write name="warehouse" property="number" scope="page"/></td>
									<td><bean:write name="warehouse" property="name" scope="page"/></td>
									<td>
										<logic:present name="warehouse" property="customer">
										<bean:write name="warehouse" property="customer.company" scope="page"/>
										</logic:present>
									</td>
									<td>
										<logic:present name="warehouse" property="location">
										<bean:write name="warehouse" property="location.name" scope="page"/>
										</logic:present>
									</td>
                  <td align="center">
										<html:link page="/warehouse/detail.do" paramId="warehouseId" paramName="warehouse" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/warehouse/form.do" paramId="warehouseId" paramName="warehouse" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/warehouse/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
