    			...
    			<html:form action="/user/list">
					...
					<tr>
						<td>
							<table width="100%">
								<tr>
									<td class="DataForm"><bean:message key="page.userName.title"/> : <html:text property="userName" size="40" styleClass="Data"/>&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
								</tr>
							</table>
						</td>
					</tr>
...
%>
                <logic:iterate id="user" name="USER" type="com.mpe.financial.model.Users">
								<% 
									sequence++;
                ...
                <tr bgcolor="<% out.print(bgcolor); %>">
                	...
                	<td class="Cell"><bean:write name="user" property="userName" scope="page"/></td>
                  <td class="Cell">
                  	<logic:iterate id="role" name="user" property="roles" type="com.mpe.financial.model.Role">
                  	<bean:write name="role" property="roleName" scope="page"/><br>
                  	</logic:iterate>
                  </td>
                  <td class="Cell">
                  	<logic:match name="user" property="active" value="true"><bean:message key="page.yes.title"/></logic:match>
										<logic:notMatch name="user" property="active" value="true"><bean:message key="page.no.title"/></logic:notMatch>
								  </td>
								  <td class="Cell"><bean:write name="user" property="userType" scope="page"/></td>
				                  <td class="Cell" align="center">
                  	<html:link page="/user/detail.do" paramId="userId" paramName="user" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
                    <html:link page="/user/form.do" paramId="userId" paramName="user" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
