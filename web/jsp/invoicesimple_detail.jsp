        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/invoiceSimple/detail">
              		...
              		<td width="45%" valign="top">
              			<table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
			                ...
			                <tr> 
			                  ...
			                  <td width="5%" align="center">:</td>
			                  <td width="65%"><bean:write name="invoice" property="invoiceDate"/></td>
			                </tr>
			                <tr> 
			                  <td width="30%" align="right"><bean:message key="page.invoiceDue.title"/></td>
			                  <td width="5%" align="center">:</td>
			                  <td width="65%"><bean:write name="invoice" property="invoiceDue"/></td>
			                </tr>
			                <tr> 
          ...
          <tr>
			...
			int i = 0;
			%>
											<logic:present name="invoice" property="invoiceSimpleDetails">
			                <logic:iterate id="invoiceDetail" name="invoice" property="invoiceSimpleDetails" type="com.mpe.financial.model.InvoiceSimpleDetail">
			                ...
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<bean:write name="invoice" property="formatedInvoiceSimpleDetailAmount"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<bean:write name="invoice" property="formatedInvoiceSimpleDiscountAmount"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<bean:write name="invoice" property="formatedInvoiceSimpleAfterDiscount"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<bean:write name="invoice" property="formatedInvoiceSimpleTaxAmount"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<logic:present name="invoice" property="currency">
													...
													-->
			                		<bean:write name="invoice" property="formatedInvoiceSimpleAfterDiscountAndTax"/></b>
			                	</td>
												<td>&nbsp;</td>
			                </tr>
			              </table>
			...
			%>
			                ...
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<bean:write name="invoice" property="formatedInvoiceSimplePrepaymentAmount"/></b>
			                	</td>
			                </tr>
			                <tr  bgcolor="#FFFFFF">
			                	...
			                	<td align="right"><b>
			                		...
			                		<bean:write name="invoice" property="formatedInvoiceSimpleAfterDiscountAndTaxAndPrepayment"/></b>
			                	</td>
			                </tr>
			              </table>
			            </td>
          ...
          <tr>
    			...
    			<tr>
    				<td align="center">
							<input class="Button" type="button" name="edit" onclick="window.location.href=('<html:rewrite page="/invoiceSimple/form.do"/>?invoiceId=<bean:write name="invoice" property="id"/>');" value="<bean:message key="page.edit.link"/>"/>&nbsp;&nbsp;
							<input class="Button" type="button" name="delete" onclick="window.location.href=('<html:rewrite page="/invoiceSimple/delete.do"/>?invoiceId=<bean:write name="invoice" property="id"/>');" value="<bean:message key="page.delete.link"/>"/>&nbsp;&nbsp;
							<input class="Button" type="button" name="back" onclick="window.location.href=('<html:rewrite page="/invoiceSimple/list.do"/>?start=<bean:write name="start" scope="session"/>&count=<bean:write name="count" scope="session"/>');" value="<bean:message key="page.back.link"/>"/>
    				</td>
    			</tr>
          </html:form>
        </table> 
