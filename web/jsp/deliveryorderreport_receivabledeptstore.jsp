          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25>RECEIVABLE DEPT. STORE</TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/deliveryOrderBonKuningReport/receivableDeptStoreList">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><bean:message key="page.bonNo.title"/></td>
                  <td class=titleField><bean:message key="page.quantity.title"/></td>
                  <td class=titleField><bean:message key="page.bruto.title"/></td>
                  <td class=titleField><bean:message key="page.discount.title"/>#1</td>
                  <td class=titleField><bean:message key="page.discount.title"/>#2</td>
                  <td class=titleField><bean:message key="page.discount.title"/>#3</td>
...
%>
                	...
                	<td align="right"><%=++i%>.</td>
									...
									<td align="right"></td>
									<td align="right"><bean:write name="deliveryOrder" property="formatedDeliveryOrderDetailAmount" scope="page"/></td>
									<td align="right"><bean:write name="deliveryOrder" property="formatedDiscountAmount1" scope="page"/></td>
									<td align="right"><bean:write name="deliveryOrder" property="formatedDiscountAmount2" scope="page"/></td>
									<td align="right"><bean:write name="deliveryOrder" property="formatedDiscountAmount3" scope="page"/></td>
									<td align="right"><bean:write name="deliveryOrder" property="formatedAmountAfterTaxAndDiscount" scope="page"/></td>
                </tr>
                </logic:iterate>
