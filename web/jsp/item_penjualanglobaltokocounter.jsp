        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/itemReport/penjualanGlobalTokoCounter">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><bean:message key="page.gender.title"/></td>
                  <td class=titleField><bean:message key="page.merk.title"/></td>
                  <td class=titleField><bean:message key="page.price.title"/></td>
                  <logic:iterate id="location" name="locationLst" type="com.mpe.financial.model.Location">
                  <td class=titleField><bean:write name="location" property="code"/></td>
                  </logic:iterate>
...
%>
                <logic:iterate id="penjualanGlobalTokoCounter" name="penjualanGlobalTokoCounterLst" type="com.mpe.financial.model.ItemPosReportStockPenjualanGlobalTokoCounter">
								<% 
									sequence++;
								...
								<tr bgcolor="<% out.print(bgcolor); %>">
									<td align="right"><%=++i%>.</td>
									<td><bean:write name="penjualanGlobalTokoCounter" property="gender" scope="page"/></td>
									<td><bean:write name="penjualanGlobalTokoCounter" property="merk" scope="page"/></td>
									<td align="right"><bean:write name="penjualanGlobalTokoCounter" property="formatedPrice" scope="page"/></td>
									<logic:iterate id="location" name="locationLst" type="com.mpe.financial.model.Location">
                  <td align="right"></td>
                  </logic:iterate>
									<td align="right"></td>
