        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/firstVendorBalance/save">
					<html:hidden property="vendorFirstBalanceId"/>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><bean:message key="page.company.title"/></td>
...
%>
								<logic:present name="firstVendorBalanceLst">
                <logic:iterate id="vendorFirstBalance" name="firstVendorBalanceLst" type="com.mpe.financial.model.VendorFirstBalance">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
									<td>
										<logic:present name="vendorFirstBalance" property="vendor">
                  	<bean:write name="vendorFirstBalance" property="vendor.code" scope="page"/>
                  	</logic:present>
									</td>
									<td>
										<logic:present name="vendorFirstBalance" property="vendor">
                  	<bean:write name="vendorFirstBalance" property="vendor.company" scope="page"/>
                  	</logic:present>
									</td>
									<td><bean:write name="vendorFirstBalance" property="firstBalanceDate" scope="page"/></td>
									<td align="right"><bean:write name="vendorFirstBalance" property="formatedAmount" scope="page"/></td>
                  <td align="center">
										<html:link page="/firstVendorBalance/form.do" paramId="vendorFirstBalanceId" paramName="vendorFirstBalance" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<html:link page="/firstVendorBalance/delete.do" paramId="vendorFirstBalanceId" paramName="vendorFirstBalance" paramProperty="id"><html:img page="/images/trash.gif" border="0" alt="Delete"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
                </logic:present>
          ...
          <tr> 
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  <td colspan="3">You can add new first balance each of vendor bellow :</td>
                </tr>
                <logic:present name="vendorLst">
                <tr> 
                  <td width="30%"><bean:message key="page.vendor.title"/></td>
