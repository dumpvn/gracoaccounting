        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/purchaseOrder/list">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						...
    						<tr>
    							<td><bean:message key="page.date.title"/></td><td>:</td><td><html:text property="fromPurchaseDate" size="12"/>&nbsp;-&nbsp;<html:text property="toPurchaseDate" size="12"/>&nbsp;(dd/MM/yyyy)&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
    						</tr>
    					</table>
    				</td>
    			</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Number')><bean:message key="page.number.title"/></a>&nbsp;<logic:match name="purchaseOrderForm" property="orderBy" value="Number"><logic:match name="purchaseOrderForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="purchaseOrderForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('PurchaseDate')><bean:message key="page.purchaseDate.title"/></a>&nbsp;<logic:match name="purchaseOrderForm" property="orderBy" value="PurchaseDate"><logic:match name="purchaseOrderForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="purchaseOrderForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Vendor.Id')><bean:message key="page.vendor.title"/></a>&nbsp;<logic:match name="purchaseOrderForm" property="orderBy" value="Vendor.Id"><logic:match name="purchaseOrderForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="purchaseOrderForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><bean:message key="page.amount.title"/></td>
                  <td class=titleField><a href=javascript:sort('ReceivingStatus')><bean:message key="page.receivingStatus.title"/></a>&nbsp;<logic:match name="purchaseOrderForm" property="orderBy" value="ReceivingStatus"><logic:match name="purchaseOrderForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="purchaseOrderForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="purchaseOrder" name="PURCHASEORDER" type="com.mpe.financial.model.PurchaseOrder">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
									<td><bean:write name="purchaseOrder" property="number" scope="page"/></td>
									<td><bean:write name="purchaseOrder" property="formatedPurchaseDate" scope="page"/></td>
									<td>
										<logic:present name="purchaseOrder" property="vendor">
										<bean:write name="purchaseOrder" property="vendor.company" scope="page"/>
										</logic:present>
									</td>
									<td align="right">
										<bean:write name="purchaseOrder" property="formatedAmountAfterTaxAndDiscount" scope="page"/>&nbsp;
										<logic:present name="purchaseOrder" property="currency">
										<bean:write name="purchaseOrder" property="currency.name" scope="page"/>
										</logic:present>
									</td>
									<td><bean:write name="purchaseOrder" property="receivingStatus" scope="page"/></td>
                  <td align="center">
										<html:link page="/purchaseOrder/detail.do" paramId="purchaseOrderId" paramName="purchaseOrder" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/purchaseOrder/form.do" paramId="purchaseOrderId" paramName="purchaseOrder" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<a href="#" onclick="window.open('<html:rewrite page="/purchaseOrder/printed.do"/>?purchaseOrderId=<bean:write name="purchaseOrder" property="id"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');"><html:img page="/images/print.gif" border="0" alt="Print"/></a>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/purchaseOrder/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
