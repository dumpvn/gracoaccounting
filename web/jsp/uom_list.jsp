...
%>
                <logic:iterate id="uom" name="UOM" type="com.mpe.financial.model.Uom">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
									<td><bean:write name="uom" property="name" scope="page"/></td>
									<td><bean:write name="uom" property="symbol" scope="page"/></td>
                  <td align="center">
										<html:link page="/uom/detail.do" paramId="uomId" paramName="uom" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/uom/form.do" paramId="uomId" paramName="uom" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/uom/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
