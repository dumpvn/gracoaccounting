        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/prepaymentToVendor/save">
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="prepaymentDate" size="12"/>&nbsp;(dd/MM/yyyy)</td>
                </tr>
                ...
                <tr> 
                  ...
                  <td width="65%">
                  	<html:select property="bankAccountId">
											<html:option value=""><bean:message key="page.selectBellow.title"/></html:option>
											<html:options collection="bankAccountLst" property="id" labelProperty="number" />
                  	</html:select>
                  </td>
                </tr>
                </logic:present>
                ...
                <tr> 
                  ...
                  <td width="65%">
                  	<html:select property="purchaseOrderId">
								...
								<logic:greaterThan name="prepaymentToVendorForm" property="prepaymentToVendorId" value="0">
