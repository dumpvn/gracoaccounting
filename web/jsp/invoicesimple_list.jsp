        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/invoiceSimple/list">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('InvoiceDue')><bean:message key="page.billDue.title"/></a>&nbsp;<logic:match name="invoiceForm" property="orderBy" value="InvoiceDue"><logic:match name="invoiceForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="invoiceForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('DeliveryOrder.Id')><bean:message key="page.deliveryOrder.title"/></a>&nbsp;<logic:match name="invoiceForm" property="orderBy" value="DeliveryOrder.Id"><logic:match name="invoiceForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="invoiceForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  ...
                  <td class=titleField><a href=javascript:sort('CustomerPaymentStatus')><bean:message key="page.customerPaymentStatus.title"/></a>&nbsp;<logic:match name="invoiceForm" property="orderBy" value="CustomerPaymentStatus"><logic:match name="invoiceForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="invoiceForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="invoice" name="INVOICE" type="com.mpe.financial.model.InvoiceSimple">
								<% 
									sequence++;
                	...
                	<td><bean:write name="invoice" property="formatedInvoiceDate" scope="page"/></td>
                	<td><bean:write name="invoice" property="formatedInvoiceDue" scope="page"/></td>
                	<td>	
                		<logic:present name="invoice" property="deliveryOrder">
                		<bean:write name="invoice" property="deliveryOrder.number" scope="page"/>
                		</logic:present>
                	</td>
									<td>	
                		...
                		<bean:write name="invoice" property="customer.company" scope="page"/>
									...
									<td><bean:write name="invoice" property="formatedInvoiceSimpleAfterDiscountAndTaxAndPrepayment" scope="page"/>&nbsp;
										<logic:present name="invoice" property="currency">
                		<bean:write name="invoice" property="currency.name" scope="page"/>
                		</logic:present>
									</td>
									<td><bean:write name="invoice" property="customerPaymentStatus" scope="page"/></td>
                  <td align="center">
										<html:link page="/invoiceSimple/detail.do" paramId="invoiceId" paramName="invoice" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/invoiceSimple/form.do" paramId="invoiceId" paramName="invoice" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<a href="#" onclick="window.open('<html:rewrite page="/invoiceSimple/printed.do"/>?invoiceId=<bean:write name="invoice" property="id"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');"><html:img page="/images/print.gif" border="0" alt="Print"/></a>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="50%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/invoiceSimple/form.do"/>');" value="<bean:message key="page.new.link"/>">&nbsp;
    								<input class="Button" type="button" name="create" onclick="window.open('<html:rewrite page="/invoiceSimple/pkp.do"/>?number=<bean:write name="invoiceForm" property="number"/>&fromInvoiceDate=<bean:write name="invoiceForm" property="fromInvoiceDate"/>&toInvoiceDate=<bean:write name="invoiceForm" property="toInvoiceDate"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');" value="PKP">
    							</td>
    						</tr>
    					</table>
    				</td>
