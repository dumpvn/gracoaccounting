        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/posOrder/downloadConfirm" enctype="multipart/form-data">
          <tr> 
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.file.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:file property="fileDownload"/></td>
                </tr>
