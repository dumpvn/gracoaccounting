            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="65%"><html:text property="number" size="10"/></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="quantity" size="4"/>&nbsp;%</td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.isAp.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:checkbox property="isAp" value="Y"/></td>
                </tr>
								<tr> 
