        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/budgetReport/chartList">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						<tr>
    							<td><bean:message key="page.year.title"/></td><td>:</td><td><html:text property="year" size="4"/></td>
    						</tr>
    						<tr>
          ...
          <tr>
    				<td>
    					<table width="100%">
    						<tr valign="top"><td>
    							<img src="<%=request.getContextPath()%>/budgetReport/chart.do?year=<bean:write name="budgetForm" property="year"/>&chartOfAccountId=<bean:write name="budgetForm" property="chartOfAccountId"/>" border="0" height="600" width="800"/>
    						</td></tr>
    					</table>
    				</td>
    			</tr>
