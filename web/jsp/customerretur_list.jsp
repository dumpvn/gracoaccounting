        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/customerRetur/list">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('DeliveryOrder.Id')><bean:message key="page.deliveryOrder.title"/></a>&nbsp;<logic:match name="customerReturForm" property="orderBy" value="DeliveryOrder.Id"><logic:match name="customerReturForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customerReturForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="customerRetur" name="CUSTOMERRETUR" type="com.mpe.financial.model.CustomerRetur">
                	...
                	<td align="right"><%=++i%>.</td>
									...
									<td><bean:write name="customerRetur" property="formatedReturDate" scope="page"/></td>
									<td>
									...
									<td>
										...
										<bean:write name="customerRetur" property="deliveryOrder.number" scope="page"/>
										</logic:present>
									</td>
                  <td align="center">
										<html:link page="/customerRetur/detail.do" paramId="customerReturId" paramName="customerRetur" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/customerRetur/form.do" paramId="customerReturId" paramName="customerRetur" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<a href="#" onclick="window.open('<html:rewrite page="/customerRetur/printed.do"/>?customerReturId=<bean:write name="customerRetur" property="id"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');"><html:img page="/images/print.gif" border="0" alt="Print"/></a>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/customerRetur/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
