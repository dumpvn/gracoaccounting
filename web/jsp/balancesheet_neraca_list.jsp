        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr><td><html:errors/></td></tr>
    			...
    			<tr><td>&nbsp;</td></tr>
    			<html:form action="/balanceSheet/neraca">
    			...
    			<tr>
    				<td align="center">
    					<input class="Button" type="button" name="back" onclick="window.open('<html:rewrite page="/balanceSheet/neracaPdf.do"/>?fromDate=<bean:write name="generalLedgerForm" property="fromDate"/>&toDate=<bean:write name="generalLedgerForm" property="toDate"/>');" value="<bean:message key="page.print.link"/>"/>
    				</td>
    			</tr>
    			-->
    			<tr>
...
%>
						                ...
						                <logic:iterate id="asset" name="ASSET" type="com.mpe.financial.model.ProfitLossReport">
														...
														<tr bgcolor="<% out.print(bgcolor); %>">
															<td colspan="2"><a href="<html:rewrite page="/balanceSheet/neracaDetail.do"/>?fromDate=<bean:write name="generalLedgerForm" property="fromDate"/>&toDate=<bean:write name="generalLedgerForm" property="toDate"/>&chartGroupId=<bean:write name="asset" property="chartOfAccountId" scope="page"/>"><b><bean:write name="asset" property="name" scope="page"/></b></a></td>
						                ...
						                <logic:iterate id="liability" name="LIABILITY" type="com.mpe.financial.model.ProfitLossReportGroup">
														<% 
															sequence++;
															String bgcolor = "FFFFFF";
															if(sequence%2 == 0){
														 ...
														 %>
														<tr bgcolor="<% out.print(bgcolor); %>">
															<td colspan="2"><a href="<html:rewrite page="/balanceSheet/neracaDetail.do"/>?fromDate=<bean:write name="generalLedgerForm" property="fromDate"/>&toDate=<bean:write name="generalLedgerForm" property="toDate"/>&chartGroupId=<bean:write name="liability" property="chartOfAccountId" scope="page"/>"><b><bean:write name="liability" property="name" scope="page"/></b></a></td>
															<td align="right"><b><bean:write name="liability" property="formatedAmount" scope="page"/></b></td>
						                </tr>
						                
						                <%int k =0;%>
						                <logic:iterate id="liabilityParent" name="liability" property="list" type="com.mpe.financial.model.ProfitLossReport">
						                <% 
															sequence++;
															bgcolor = "FFFFFF";
															if(sequence%2 == 0){
						                ...
						                <tr bgcolor="<% out.print(bgcolor); %>">
						                	<td align="right"><%=++k%>.</td>
															<td><bean:write name="liabilityParent" property="name" scope="page"/></td>
															<td align="right"><bean:write name="liabilityParent" property="formatedAmount" scope="page"/></td>
						                </tr>
						                </logic:iterate>
...
%>
						                ...
						                <logic:iterate id="equity" name="EQUITY" type="com.mpe.financial.model.ProfitLossReport">
														<% 
														 ...
														 %>
														<tr bgcolor="<% out.print(bgcolor); %>">
															<td colspan="2"><a href="<html:rewrite page="/balanceSheet/neracaDetail.do"/>?fromDate=<bean:write name="generalLedgerForm" property="fromDate"/>&toDate=<bean:write name="generalLedgerForm" property="toDate"/>&chartGroupId=<bean:write name="equity" property="chartOfAccountId" scope="page"/>"><b><bean:write name="equity" property="name" scope="page"/></b></a></td>
															<td align="right"><b><bean:write name="equity" property="formatedAmount" scope="page"/></b></td>
						                </tr>
						                
						                <%int l =0;%>
						                <logic:iterate id="equityParent" name="equity" property="list" type="com.mpe.financial.model.ProfitLossReport">
						                <% 
															sequence++;
															bgcolor = "FFFFFF";
															if(sequence%2 == 0){
						                ...
						                <tr bgcolor="<% out.print(bgcolor); %>">
						                	<td align="right"><%=++l%>.</td>
															...
															<td align="right"><bean:write name="equityParent" property="formatedAmount" scope="page"/></td>
						                </tr>
						                </logic:iterate>
          ...
          <tr>
    			...
    			<tr>
    				<td align="center">
    					<input class="Button" type="button" name="back" onclick="window.open('<html:rewrite page="/balanceSheet/neracaPdf.do"/>?fromDate=<bean:write name="generalLedgerForm" property="fromDate"/>&toDate=<bean:write name="generalLedgerForm" property="toDate"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');" value="<bean:message key="page.print.link"/>"/>
    				</td>
    			</tr>
