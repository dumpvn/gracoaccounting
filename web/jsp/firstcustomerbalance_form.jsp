        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/firstCustomerBalance/save">
					<html:hidden property="customerFirstBalanceId"/>
...
%>
								<logic:present name="firstCustomerBalanceLst">
                <logic:iterate id="customerFirstBalance" name="firstCustomerBalanceLst" type="com.mpe.financial.model.CustomerFirstBalance">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
									<td>
										<logic:present name="customerFirstBalance" property="customer">
                  	<bean:write name="customerFirstBalance" property="customer.code" scope="page"/>
                  	</logic:present>
									</td>
									<td>
										<logic:present name="customerFirstBalance" property="customer">
                  	<bean:write name="customerFirstBalance" property="customer.company" scope="page"/>
                  	</logic:present>
									</td>
									<td><bean:write name="customerFirstBalance" property="firstBalanceDate" scope="page"/></td>
									<td align="right"><bean:write name="customerFirstBalance" property="formatedAmount" scope="page"/></td>
                  <td align="center">
										<html:link page="/firstCustomerBalance/form.do" paramId="customerFirstBalanceId" paramName="customerFirstBalance" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<html:link page="/firstCustomerBalance/delete.do" paramId="customerFirstBalanceId" paramName="customerFirstBalance" paramProperty="id"><html:img page="/images/trash.gif" border="0" alt="Delete"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
                </logic:present>
          ...
          <tr> 
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  <td colspan="3">You can add new first balance each of customer bellow :</td>
                </tr>
