        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/item/customFieldSave">
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                ...
                <tr> 
                  <td colspan="3" align="center">
			                  ...
			                  <td class=titleField><bean:message key="page.customField.title"/></td>
			                  <td class=titleField><bean:message key="page.value.title"/></td>
			                  <td class=titleField>&nbsp;</td>
			                </tr>
			                <% int k=0; %>
			                <logic:present name="itemCustomFieldLst">
			                <logic:iterate id="itemCustomField" name="itemCustomFieldLst" type="com.mpe.financial.model.ItemCustomField" scope="request">
			                <tr bgcolor="#FFFFFF" align=center> 
			                  <td><%= ++k%></td>
			                  <td>
			                  	<logic:present name="itemCustomField" property="id.customField">
			                  	<bean:write name="itemCustomField" property="id.customField.name" scope="page"/>
			                  	</logic:present>
			                  </td>
			                  <td><bean:write name="itemCustomField" property="value" scope="page"/></td>
			                  <td>
			                  	<a href="<html:rewrite page="/item/customFieldForm.do"/>?itemId=<bean:write name="itemForm" property="itemId"/>&customFieldId=<bean:write name="itemCustomField" property="id.customField.id"/>"><html:img page="/images/edit.gif" border="0" alt="Edit"/></a>&nbsp;
			                  	<a href="<html:rewrite page="/item/customFieldForm.do"/>?itemId=<bean:write name="itemForm" property="itemId"/>&customFieldId=<bean:write name="itemCustomField" property="id.customField.id"/>&subaction=REMOVEITEMVENDOR&caller=/item/customFieldForm.do"><html:img page="/images/trash.gif" border="0" alt="Remove"/></a>
			                  </td>
			                </tr>
			                </logic:iterate>
			                </logic:present>
			                <tr>
			                	<td>&nbsp;</td>
			                	<td>
			                		<html:select property="customFieldId">
														<html:option value=""><bean:message key="page.selectBellow.title"/></html:option>
														<html:options collection="customFieldLst" property="id" labelProperty="name" />
			                  	</html:select>
			                	</td>
			                	<td><html:text property="value" size="40"/></td>
			                 	<td>
