          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25>CUSTOMER TABLE</TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/customerReport/list">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Npwp')><bean:message key="page.npwp.title"/></a>&nbsp;<logic:match name="customersForm" property="orderBy" value="Npwp"><logic:match name="customersForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="customersForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><bean:message key="page.telephone.title"/>/<bean:message key="page.fax.title"/><br><bean:message key="page.contactPerson.title"/></td>
                </tr>
<%
int i = 0;
try {
...
%>
                <logic:iterate id="customer" name="CUSTOMER" type="com.mpe.financial.model.Customers">
                	...
                	<td><bean:write name="customer" property="company" scope="page"/></td>
									...
									<td><bean:write name="customer" property="npwp" scope="page"/></td>
									<td><bean:write name="customer" property="telephone" scope="page"/>/<bean:write name="customer" property="fax" scope="page"/></td>
                </tr>
                </logic:iterate>
              </table>
            </td>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.open('<html:rewrite page="/customerReport/pdfList.do"/>?company=<bean:write name="customersForm" property="company"/>&orderBy=<bean:write name="customersForm" property="orderBy"/>&ascDesc=<bean:write name="customersForm" property="ascDesc"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');" value="<bean:message key="page.print.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
