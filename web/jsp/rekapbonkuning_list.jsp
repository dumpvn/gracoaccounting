        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/rekapBonKuning/list">
    			...
    			<tr>
    				<td>
    					<table width="100%">
    						...
    						<tr>
    							<td><bean:message key="page.date.title"/></td><td>:</td><td><html:text property="fromBonKuningDate" size="12"/>&nbsp;-&nbsp;<html:text property="toBonKuningDate" size="12"/>&nbsp;(dd/MM/yyyy)&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
    						</tr>
    					</table>
    				</td>
    			</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('DeliveryDate')><bean:message key="page.deliveryDate.title"/></a>&nbsp;<logic:match name="deliveryOrderForm" property="orderBy" value="InvoiceDate"><logic:match name="deliveryOrderForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="deliveryOrderForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><bean:message key="page.bonKuningDate.title"/></td>
                  ...
                  <td class=titleField><a href=javascript:sort('InvoiceStatus')><bean:message key="page.invoiceStatus.title"/></a>&nbsp;<logic:match name="deliveryOrderForm" property="orderBy" value="CustomerPaymentStatus"><logic:match name="deliveryOrderForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="deliveryOrderForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="invoice" name="REKAP" type="com.mpe.financial.model.DeliveryOrder">
								<% 
									sequence++;
                	...
                	<td><bean:write name="invoice" property="deliveryDate" scope="page"/></td>
                	<td><bean:write name="invoice" property="fromBonKuningDate" scope="page"/>-<bean:write name="invoice" property="toBonKuningDate" scope="page"/></td>
									<td>	
                		<logic:present name="invoice" property="customer">
                		<bean:write name="invoice" property="customer.company" scope="page"/>
                		</logic:present>
                	</td>
									<td><bean:write name="invoice" property="formatedAmountAfterTaxAndDiscount" scope="page"/>&nbsp;
										<logic:present name="invoice" property="currency">
                		<bean:write name="invoice" property="currency.name" scope="page"/>
                		</logic:present>
									</td>
									<td><bean:write name="invoice" property="invoiceStatus" scope="page"/></td>
                  <td align="center">
										<html:link page="/rekapBonKuning/detail.do" paramId="deliveryOrderId" paramName="invoice" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/rekapBonKuning/form.do" paramId="deliveryOrderId" paramName="invoice" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<a href="#" onclick="window.open('<html:rewrite page="/rekapBonKuning/printed.do"/>?deliveryOrderId=<bean:write name="invoice" property="id"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');"><html:img page="/images/print.gif" border="0" alt="Print"/></a>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/rekapBonKuning/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
