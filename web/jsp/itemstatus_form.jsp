        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/itemStatus/save">
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="65%"><html:text property="code" size="30"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.variable.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="variable" size="10"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.isDefaultStatus.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:checkbox property="isDefaultStatus" value="Y"/>&nbsp;<bean:message key="page.yes.title"/></td>
                </tr>
								<tr> 
                  <td width="30%" align="right"><bean:message key="page.description.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:textarea property="description" cols="50" rows="5"/></td>
                </tr>
              </table>
            </td>
          </tr>
