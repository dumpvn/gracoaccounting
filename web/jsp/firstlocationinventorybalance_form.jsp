        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/firstLocationInventoryBalance/save">
					<html:hidden property="locationItemFirstBalanceId"/>
...
%>
								<logic:present name="firstLocationItemBalanceLst">
                <logic:iterate id="itemFirstBalance" name="firstLocationItemBalanceLst" type="com.mpe.financial.model.ItemFirstBalance">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
									<td>
										<logic:present name="itemFirstBalance" property="location">
                  	<bean:write name="itemFirstBalance" property="location.name" scope="page"/>
                  	</logic:present>
									</td>
									<td>
                  ...
                  <td align="center">
										<html:link page="/firstLocationInventoryBalance/form.do" paramId="locationItemFirstBalanceId" paramName="itemFirstBalance" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<html:link page="/firstLocationInventoryBalance/delete.do" paramId="locationItemFirstBalanceId" paramName="itemFirstBalance" paramProperty="id"><html:img page="/images/trash.gif" border="0" alt="Delete"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
                </logic:present>
