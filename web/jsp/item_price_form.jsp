        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/item/priceSave" enctype="multipart/form-data">
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                ...
                <tr> 
                  <td colspan="3" align="center">
			                ...
			                <% int z=0; %>
			                <logic:present name="itemPriceLst">
			                <logic:iterate id="itemPrice" name="itemPriceLst" type="com.mpe.financial.model.ItemPrice" scope="request">
			                <tr bgcolor="#FFFFFF" align=center> 
			                  ...
			                  <td>
			                  	<logic:present name="itemPrice" property="itemUnit">
			                  	<bean:write name="itemPrice" property="itemUnit.name" scope="page"/>
			                  	</logic:present>
			                  </td>
												<td>
			                  ...
			                  <td>
			                  	<a href="<html:rewrite page="/item/priceForm.do"/>?itemId=<bean:write name="itemForm" property="itemId"/>&itemPriceCategoryId=<bean:write name="itemPrice" property="id.itemPriceCategory.id"/>"><html:img page="/images/edit.gif" border="0" alt="Edit"/></a>&nbsp;
			                  	<a href="<html:rewrite page="/item/priceForm.do"/>?itemId=<bean:write name="itemForm" property="itemId"/>&itemPriceCategoryId=<bean:write name="itemPrice" property="id.itemPriceCategory.id"/>&subaction=REMOVEITEMPRICE&caller=/item/priceForm.do"><html:img page="/images/trash.gif" border="0" alt="Remove"/></a>
			                  </td>
			                </tr>
			                </logic:iterate>
			                </logic:present>
			                <tr>
			                	<td>&nbsp;</td>
			                	<td>
			                		<html:select property="itemPriceCategoryId">
			                	...
			                	<td>
			                  	<html:select property="itemPriceCurrencyId">
														<html:option value=""><bean:message key="page.selectBellow.title"/></html:option>
														<html:options collection="currencyLst" property="id" labelProperty="name" />
			                  	</html:select>
			                  </td>
			                 	<td><html:checkbox property="isDefault" value="Y"/></td>
												<td>
			                 	...
			                 	<td>
			                 		<html:select property="chartOfAccountId">
												...
												<td>
			                 		<html:select property="salesTaxId">
														<html:option value=""><bean:message key="page.selectBellow.title"/></html:option>
														<html:options collection="salesTaxLst" property="id" labelProperty="name" />
			                  	</html:select>
			                 	</td>
			                 	<td>
			                 		<html:submit styleClass="button" onclick="this.form.subaction.value='ADDITEMPRICE'">ADD</html:submit>
			                 	</td>
			                </tr>
										</table>
									</td>
