        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/memberDiscount/save">
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="amount" size="5"/>&nbsp;%</td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.isActive.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:checkbox property="isActive" value="Y"/>&nbsp;<bean:message key="page.yes.title"/></td>
                </tr>
