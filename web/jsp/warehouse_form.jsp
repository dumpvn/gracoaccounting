        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/warehouse/save">
          ...
          <tr> 
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <logic:equal name="warehouseForm" property="warehouseId" value="0">
                <tr> 
                ...
                <logic:greaterThan name="warehouseForm" property="warehouseId" value="0">
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.number.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="number" readonly="true" size="15"/></td>
                </tr>
                </logic:greaterThan>
                <tr> 
