        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/location/list">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Code')><bean:message key="page.code.title"/></a>&nbsp;<logic:match name="locationForm" property="orderBy" value="Code"><logic:match name="locationForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="locationForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Name')><bean:message key="page.name.title"/></a>&nbsp;<logic:match name="locationForm" property="orderBy" value="Name"><logic:match name="locationForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="locationForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><a href=javascript:sort('Address')><bean:message key="page.address.title"/></a>&nbsp;<logic:match name="locationForm" property="orderBy" value="Address"><logic:match name="locationForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="locationForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="location" name="LOCATION" type="com.mpe.financial.model.Location">
                	...
                	<td align="right"><%=++i%>.</td>
                	<td><bean:write name="location" property="code" scope="page"/></td>
									<td><bean:write name="location" property="name" scope="page"/></td>
									<td><bean:write name="location" property="address" scope="page"/></td>
                  <td align="center">
										<html:link page="/location/detail.do" paramId="locationId" paramName="location" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/location/form.do" paramId="locationId" paramName="location" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="30%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/location/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
