        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/itemReport/stockGlobalTokoCounter">
...
%>
                <logic:iterate id="stockGlobalTokoCounter" name="stockGlobalTokoCounterLst" type="com.mpe.financial.model.ItemPosReportStockPenjualanGlobalTokoCounter">
								<% 
									sequence++;
								...
								<tr bgcolor="<% out.print(bgcolor); %>">
									<td align="right"><%=++i%>.</td>
									<td><bean:write name="stockGlobalTokoCounter" property="gender" scope="page"/></td>
									<td><bean:write name="stockGlobalTokoCounter" property="merk" scope="page"/></td>
									<td align="right"><bean:write name="stockGlobalTokoCounter" property="formatedPrice" scope="page"/></td>
									<logic:iterate id="location" name="locationLst" type="com.mpe.financial.model.Location">
                  <td align="right"></td>
                  </logic:iterate>
									<td align="right"></td>
