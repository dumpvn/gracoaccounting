        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/paymentToVendor/list">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Vendor.Id')><bean:message key="page.vendor.title"/></a>&nbsp;<logic:match name="paymentToVendorForm" property="orderBy" value="Vendor.Id"><logic:match name="paymentToVendorForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="paymentToVendorForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td class=titleField><bean:message key="page.amount.title"/></td>
                  <td class=titleField><a href=javascript:sort('BankAccount.Id')><bean:message key="page.bankAccount.title"/></a>&nbsp;<logic:match name="paymentToVendorForm" property="orderBy" value="BankAccount.Id"><logic:match name="paymentToVendorForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="paymentToVendorForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
...
%>
                <logic:iterate id="paymentToVendor" name="PAYMENTTOVENDOR" type="com.mpe.financial.model.PaymentToVendor">
                	...
                	<td align="right"><%=++i%>.</td>
									...
									<td><bean:write name="paymentToVendor" property="formatedPaymentDate" scope="page"/></td>
									<td>
										<logic:present name="paymentToVendor" property="vendor">
										<bean:write name="paymentToVendor" property="vendor.company" scope="page"/>
										</logic:present>
									</td>
									<td><bean:write name="paymentToVendor" property="formatedPaymentAmount" scope="page"/>&nbsp;
										<logic:present name="paymentToVendor" property="currency">
										<bean:write name="paymentToVendor" property="currency.name" scope="page"/>
										</logic:present>
									</td>
									<td>
                  ...
                  <td align="center">
										<html:link page="/paymentToVendor/detail.do" paramId="paymentToVendorId" paramName="paymentToVendor" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/paymentToVendor/form.do" paramId="paymentToVendorId" paramName="paymentToVendor" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/paymentToVendor/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
