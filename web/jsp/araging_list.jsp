          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25><bean:message key="page.arAgingTitle.title"/></TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
    						...
    						<tr>
    							<td><bean:message key="page.customer.title"/></td><td>:</td><td>
    								<html:select property="customerId">
											...
											<html:options collection="customersLst" property="id" labelProperty="company" />
                  	</html:select>
                  </td>
    						</tr>
    						<tr>
...
%>
								<logic:present name="ARAGING">
                <logic:iterate id="arAging" name="ARAGING" type="com.mpe.financial.model.ArAgingReport">
								<% 
									sequence++;
                	...
                	<td align="right"><%=++i%>.</td>
                	<td><bean:write name="arAging" property="company" scope="page"/></td>
									<td align="right"><bean:write name="arAging" property="formatedAging0" scope="page"/></td>
									<td align="right"><bean:write name="arAging" property="formatedAging030" scope="page"/></td>
									<td align="right"><bean:write name="arAging" property="formatedAging3060" scope="page"/></td>
									<td align="right"><bean:write name="arAging" property="formatedAging6090" scope="page"/></td>
									<td align="right"><bean:write name="arAging" property="formatedAging90" scope="page"/></td>
                </tr>
                </logic:iterate>
                </logic:present>
              </table>
