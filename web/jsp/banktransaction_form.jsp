        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/bankTransaction/save">
					<html:hidden property="bankTransactionId"/>
					<html:hidden property="isTransfer"/>
					<html:hidden property="isManualTransaction"/>
					<html:hidden property="isPosted"/>
					<html:hidden property="reconcileBankFrom"/>
					<html:hidden property="reconcileBankTo"/>
            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="65%"><html:text property="number" size="15"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.transactionDate.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="transactionDate" size="12"/>&nbsp;(dd/MM/yyyy)</td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="reference" size="30"/></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:textarea property="note" cols="40" rows="4"/></td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          <tr>
			...
			%>
			                ...
			                <tr bgcolor="#FFFFFF" align=center>
			                  ...
			                  <td align="center">
													<a href="<html:rewrite page="/bankTransaction/form.do"/>?bankTransactionId=<bean:write name="bankTransactionForm" property="bankTransactionId"/>&chartOfAccountId=<bean:write name="journalDetail" property="id.chartOfAccount.id"/>"><html:img page="/images/edit.gif" border="0" alt="Edit"/></a>&nbsp;
			                  	<a href="<html:rewrite page="/bankTransaction/form.do"/>?bankTransactionId=<bean:write name="bankTransactionForm" property="bankTransactionId"/>&chartOfAccountId=<bean:write name="journalDetail" property="id.chartOfAccount.id"/>&subaction=REMOVEBANKTRANSACTIONDETAIL&caller=/bankTransaction/form.do"><html:img page="/images/trash.gif" border="0" alt="Remove"/></a>
			                  </td>
			                </tr>
			                </logic:iterate>
			                </logic:present>
			                ...
			                <tr>
			                	...
			                	<td colspan="2"><html:text property="detailAmount" size="25"/></td>
			                	<td>
			                	...
			                	<td><html:submit styleClass="button" onclick="this.form.subaction.value='ADDBANKTRANSACTIONDETAIL'">ADD</html:submit></td>
			                </tr>
