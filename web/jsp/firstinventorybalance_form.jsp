        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/firstInventoryBalance/save">
					<html:hidden property="itemFirstBalanceId"/>
...
%>
								<logic:present name="firstItemBalanceLst">
                <logic:iterate id="itemFirstBalance" name="firstItemBalanceLst" type="com.mpe.financial.model.ItemFirstBalance">
								<% 
									sequence++;
                  ...
                  <td align="center">
										<html:link page="/firstInventoryBalance/form.do" paramId="itemFirstBalanceId" paramName="itemFirstBalance" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
										<html:link page="/firstInventoryBalance/delete.do" paramId="itemFirstBalanceId" paramName="itemFirstBalance" paramProperty="id"><html:img page="/images/trash.gif" border="0" alt="Delete"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
                </logic:present>
