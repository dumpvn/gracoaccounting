        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/deliveryOrderStore/save">
              	...
              	<tr valign="top">
              		<td width="45%" valign="top">
              			<table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
			                ...
			                <logic:present name="customerAliasLst">
			                <tr> 
          ...
          <tr>
			...
			%>
			                ...
			                <tr bgcolor="#FFFFFF" align=center>
			                  ...
			                  <td align="center">
													<a href="<html:rewrite page="/deliveryOrderStore/form.do"/>?deliveryOrderId=<bean:write name="deliveryOrderForm" property="deliveryOrderId"/>&itemId=<bean:write name="deliveryOrderDetail" property="id.item.id"/>"><html:img page="/images/edit.gif" border="0" alt="Edit"/></a>&nbsp;
			                  	<a href="<html:rewrite page="/deliveryOrderStore/form.do"/>?deliveryOrderId=<bean:write name="deliveryOrderForm" property="deliveryOrderId"/>&itemId=<bean:write name="deliveryOrderDetail" property="id.item.id"/>&subaction=REMOVEDELIVERYORDERDETAIL&caller=/deliveryOrderStore/form.do"><html:img page="/images/trash.gif" border="0" alt="Remove"/></a>
			                  </td>
			                </tr>
			                </logic:iterate>
			                </logic:present>
