          ...
          <TD align=middle width="80%">
            <TABLE cellSpacing=0 cellPadding=0 width="92%" border=0>
              <TR>
                ...
                <TD class=title width="100%" background=<html:rewrite page="/images/bg_title.gif"/> height=25>SUPPLIER TABLE</TD></TR>
            </TABLE>
          </TD>
        </TR>
        <TR>
        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/vendorReport/list">
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td class=titleField><a href=javascript:sort('Npwp')><bean:message key="page.npwp.title"/></a>&nbsp;<logic:match name="vendorsForm" property="orderBy" value="Npwp"><logic:match name="vendorsForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="vendorsForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td> 
...
%>
                <logic:iterate id="vendor" name="VENDOR" type="com.mpe.financial.model.Vendors">
                	...
                	<td><bean:write name="vendor" property="npwp" scope="page"/></td>
									<td><bean:write name="vendor" property="telephone" scope="page"/>/<bean:write name="vendor" property="fax" scope="page"/></td>
                </tr>
                </logic:iterate>
              </table>
            </td>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.open('<html:rewrite page="/vendorReport/pdfList.do"/>?company=<bean:write name="vendorsForm" property="company"/>&orderBy=<bean:write name="vendorsForm" property="orderBy"/>&ascDesc=<bean:write name="vendorsForm" property="ascDesc"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');" value="<bean:message key="page.print.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
