...
<!-- content -->    
      <TABLE height=50 cellSpacing=1 cellPadding=1 border=0 width="100%" valign="top"><BR><BR>
        ...
        <TR>
    	  ...
    	  <html:form action="/outgoingSms/list">
			...
			<tr>
				<td>
					<table width="100%">
						<tr>
							<td class="DataForm"><bean:message key="page.message.title"/> : <html:text property="message" size="60" styleClass="Data"/>&nbsp;<html:submit styleClass="Button"><bean:message key="page.search.link"/></html:submit></td>
						</tr>
					</table>
				</td>
				</tr>
            ...
            <td align="center"> 
              <table border="0" cellspacing=1 cellpadding=2 bgcolor="#cccccc" width="100%">
                <tr align="center"> 
                  ...
                  <td width="35%" class="titleField"><a href=javascript:sort('OutgoingSmsDate')><bean:message key="page.outgoingSmsDate.title"/></a>&nbsp;<logic:match name="outgoingSmsForm" property="orderBy" value="OutgoingSmsDate"><logic:match name="outgoingSmsForm" property="ascDesc" value="desc"><html:img page="/images/sort_terang.gif" border="0"/></logic:match><logic:match name="outgoingSmsForm" property="ascDesc" value="asc"><html:img page="/images/sort2_terang.gif" border="0"/></logic:match></logic:match></td>
                  <td width="50%" class="titleField"><bean:message key="page.message.title"/></td>
...
%>
                <logic:iterate id="outgoingSms" name="OUTGOINGSMS" type="com.mpe.financial.model.OutgoingSms">
								<% 
									sequence++;
                ...
                <tr bgcolor="<% out.print(bgcolor); %>">
                  ...
                  <td class="Cell"><bean:write name="outgoingSms" property="outgoingSmsDate" scope="page"/></td>
                  <td class="Cell"><bean:write name="outgoingSms" property="message" scope="page"/></td>
                  <td class="Cell" align="center">
                  	<html:link page="/outgoingSms/detail.do" paramId="outgoingSmsId" paramName="outgoingSms" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
                    <html:link page="/outgoingSms/form.do" paramId="outgoingSmsId" paramName="outgoingSms" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/outgoingSms/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
