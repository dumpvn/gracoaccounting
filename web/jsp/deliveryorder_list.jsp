        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/deliveryOrder/list">
...
%>
                <logic:iterate id="deliveryOrder" name="DELIVERYORDER" type="com.mpe.financial.model.DeliveryOrder">
                  ...
                  <td align="center">
										<html:link page="/deliveryOrder/detail.do" paramId="deliveryOrderId" paramName="deliveryOrder" paramProperty="id"><html:img page="/images/detail.gif" border="0" alt="Detail"/></html:link>&nbsp;
										<html:link page="/deliveryOrder/form.do" paramId="deliveryOrderId" paramName="deliveryOrder" paramProperty="id"><html:img page="/images/edit.gif" border="0" alt="Edit"/></html:link>&nbsp;
                  	<a href="#" onclick="window.open('<html:rewrite page="/deliveryOrder/printed.do"/>?deliveryOrderId=<bean:write name="deliveryOrder" property="id"/>','gg','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes,width=800,height=600');"><html:img page="/images/print.gif" border="0" alt="Print"/></a>
                  </td>
                </tr>
                </logic:iterate>
              </table>
    			...
    			<tr>
    				<td align="center">
    					<table width="10%">
    						<tr>
    							<td align="center">
    								<input class="Button" type="button" name="create" onclick="window.location.href=('<html:rewrite page="/deliveryOrder/form.do"/>');" value="<bean:message key="page.new.link"/>">
    							</td>
    						</tr>
    					</table>
    				</td>
