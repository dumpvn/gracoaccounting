            ...
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  ...
                  <td width="65%"><html:radio property="type" value="Standard"/>&nbsp;Standard&nbsp;&nbsp;<html:radio property="type" value="Date Driven"/>&nbsp;Date Driven</td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="netDue" size="20"/></td>
                </tr>
                <!--
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.nextMonthDue.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="nextMonthDue" size="20"/></td>
                </tr>
                -->
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.discount.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="discount" size="5"/>&nbsp;%</td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.extraDiscount.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="extraDiscount" size="5"/>&nbsp;%</td>
                </tr>
								<tr> 
