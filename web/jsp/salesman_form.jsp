        ...
        <TR>
	      ...
	      <table width="97%" border="0" cellspacing="2" cellpadding="0">
	      	<tr valign="top"><td><html:errors/></td></tr>
    			...
    			<html:form action="/salesman/save">
          ...
          <tr> 
            <td align="center"> 
              <table width="100%" border="0" cellspacing="1" cellpadding="0" class=abuabu>
                <tr> 
                  <td width="40%" align="right"><bean:message key="page.degree.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="55%">
                  	<html:select property="degreeId">
											<html:option value=""><bean:message key="page.selectBellow.title"/></html:option>
											<html:options collection="degreeLst" property="id" labelProperty="name" />
                  	</html:select>
                  </td>
                </tr>
                <tr> 
                  <td width="40%" align="right"><bean:message key="page.department.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="55%">
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="fullName" size="35"/></td>
                </tr>
                <tr> 
                  <td width="30%" align="right"><bean:message key="page.nickName.title"/></td>
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="nickName" size="30"/></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="5%" align="center">:</td>
                  <td width="65%"><html:text property="mobile" size="20"/></td>
                </tr>
								<tr> 
