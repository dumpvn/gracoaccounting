...
public class CustomerReturReportAction extends Action {
	...
	private ActionForward performPdfList(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
		    ...
		    // write to pdf document
				...
				float[] b = {4,7,8,10,10,8,8,8,8,10,9,8};
				table2.setWidths(b);
				...
				cell.setColspan(12);
				table2.addCell(cell);
				cell = new Cell(new Phrase("SALES RETURN", FontFactory.getFont(FontFactory.HELVETICA, 20, Font.BOLD)));
				cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setColspan(12);
				table2.addCell(cell);
				...
				while (iterator.hasNext()) {
				    ...
				    cell = new Cell(new Phrase(++i+".", FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						...
						table2.addCell(cell);
				    cell = new Cell(new Phrase(customerRetur.getFormatedReturDate(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_LEFT);
						table2.addCell(cell);
				    cell = new Cell(new Phrase(customerRetur.getNumber(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_LEFT);
						table2.addCell(cell);
				    cell = new Cell(new Phrase(customerRetur.getCustomer().getCompany(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_LEFT);
						table2.addCell(cell);
				    cell = new Cell(new Phrase(customerRetur.getNote(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_LEFT);
						table2.addCell(cell);
				    cell = new Cell(new Phrase(customerRetur.getFormatedAmountDiscount(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						table2.addCell(cell);
				    cell = new Cell(new Phrase(customerRetur.getFormatedAmountTax(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						table2.addCell(cell);
				    cell = new Cell(new Phrase(customerRetur.getFormatedAmountAfterTaxAndDiscount(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						table2.addCell(cell);
						Table t3 = new Table(1);
						Iterator iterator3 = customerRetur.getCustomerReturDetails().iterator();
						while (iterator3.hasNext()) {
						    CustomerReturDetail customerReturDetail  = (CustomerReturDetail)iterator3.next();
						    cell = new Cell(new Phrase(customerReturDetail.getId().getItem().getCode(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
								cell.setBorder(Rectangle.RIGHT);
								cell.setHorizontalAlignment(Element.ALIGN_LEFT);
								t3.addCell(cell);
						}
						...
						Iterator iterator4 = customerRetur.getCustomerReturDetails().iterator();
						while (iterator4.hasNext()) {
						    CustomerReturDetail customerReturDetail  = (CustomerReturDetail)iterator4.next();
						    cell = new Cell(new Phrase(Double.toString(customerReturDetail.getQuantity()), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
								cell.setBorder(Rectangle.RIGHT);
								cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
								t4.addCell(cell);
						}
						...
						Iterator iterator5 = customerRetur.getCustomerReturDetails().iterator();
						while (iterator5.hasNext()) {
						    CustomerReturDetail customerReturDetail  = (CustomerReturDetail)iterator5.next();
						    cell = new Cell(new Phrase(customerReturDetail.getItemUnit().getSymbol(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
								cell.setBorder(Rectangle.RIGHT);
								cell.setHorizontalAlignment(Element.ALIGN_LEFT);
								t5.addCell(cell);
						}
						...
						Iterator iterator6 = customerRetur.getCustomerReturDetails().iterator();
						while (iterator6.hasNext()) {
						    CustomerReturDetail customerReturDetail  = (CustomerReturDetail)iterator6.next();
						    cell = new Cell(new Phrase(customerReturDetail.getFormatedPrice(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
