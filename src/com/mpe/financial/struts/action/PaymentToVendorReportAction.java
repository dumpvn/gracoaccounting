...
public class PaymentToVendorReportAction extends Action {
	...
	private ActionForward performPdfList(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
		    ...
		    // write to pdf document
				...
				float[] b = {5,15,7,8,7,8,10,10,10,10,10};
				table2.setWidths(b);
				...
				cell.setColspan(11);
				table2.addCell(cell);
				cell = new Cell(new Phrase("PAYMENT ACTIVITY", FontFactory.getFont(FontFactory.HELVETICA, 20, Font.BOLD)));
				cell.setBorder(Rectangle.NO_BORDER);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setColspan(11);
				table2.addCell(cell);
				...
				table2.addCell(cell);
				cell = new Cell(new Phrase("ACTIVITY DATE",FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD)));
				cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setBackgroundColor(new Color(0xC0, 0xC0, 0xC0));
				cell.setBorderWidth(1);
				...
				cell.setBorder(Rectangle.TOP | Rectangle.BOTTOM | Rectangle.LEFT);
				table2.addCell(cell);
				cell = new Cell(new Phrase("ACTIVITY NO",FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD)));
				cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
				cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell.setBackgroundColor(new Color(0xC0, 0xC0, 0xC0));
				cell.setBorderWidth(1);
				...
				while (iterator.hasNext()) {
				    PaymentToVendor paymentToVendor = (PaymentToVendor)iterator.next();
				    cell = new Cell(new Phrase(++i+".", FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						table2.addCell(cell);
						cell = new Cell(new Phrase(paymentToVendor.getVendor()!=null?paymentToVendor.getVendor().getCompany():"", FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_LEFT);
						table2.addCell(cell);
						cell = new Cell(new Phrase(paymentToVendor.getFormatedPaymentDate(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_LEFT);
						table2.addCell(cell);
						cell = new Cell(new Phrase(paymentToVendor.getNumber(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_LEFT);
						table2.addCell(cell);
						Table t3 = new Table(1);
						Iterator iterator3 = paymentToVendor.getPaymentToVendorDetails().iterator();
						while (iterator3.hasNext()) {
						    PaymentToVendorDetail paymentToVendorDetail = (PaymentToVendorDetail)iterator3.next();
						    cell = new Cell(new Phrase(paymentToVendorDetail.getId().getVendorBill().getReceiving().getFormatedReceivingDate(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
								cell.setBorder(Rectangle.RIGHT);
								cell.setHorizontalAlignment(Element.ALIGN_LEFT);
								t3.addCell(cell);
						}
						...
						Iterator iterator4 = paymentToVendor.getPaymentToVendorDetails().iterator();
						while (iterator4.hasNext()) {
						    PaymentToVendorDetail paymentToVendorDetail = (PaymentToVendorDetail)iterator4.next();
						    cell = new Cell(new Phrase(paymentToVendorDetail.getId().getVendorBill().getReceiving().getNumber(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
								cell.setBorder(Rectangle.RIGHT);
								cell.setHorizontalAlignment(Element.ALIGN_LEFT);
								t4.addCell(cell);
						}
						...
						Iterator iterator5 = paymentToVendor.getPaymentToVendorDetails().iterator();
						while (iterator5.hasNext()) {
						    PaymentToVendorDetail paymentToVendorDetail = (PaymentToVendorDetail)iterator5.next();
						    cell = new Cell(new Phrase(paymentToVendorDetail.getId().getVendorBill().getReceiving().getFormatedAmountAfterTaxAndDiscount(), FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
								cell.setBorder(Rectangle.RIGHT);
								cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
								t5.addCell(cell);
						}
						table2.insertTable(t5);
						cell = new Cell(new Phrase(paymentToVendor.getMethod().equalsIgnoreCase("Cash")?paymentToVendor.getFormatedPaymentAmount():"", FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						table2.addCell(cell);
						cell = new Cell(new Phrase(!paymentToVendor.getMethod().equalsIgnoreCase("Cash")?paymentToVendor.getFormatedPaymentAmount():"", FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						...
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						table2.addCell(cell);
						cell = new Cell(new Phrase(paymentToVendor.getBankAccount()!=null?paymentToVendor.getBankAccount().getBank().getName():"", FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
						cell.setBorder(Rectangle.RIGHT);
						cell.setHorizontalAlignment(Element.ALIGN_LEFT);
						table2.addCell(cell);
						cell = new Cell(new Phrase(paymentToVendor.getBankAccount()!=null?paymentToVendor.getBankAccount().getNumber():"", FontFactory.getFont(FontFactory.HELVETICA, 6, Font.NORMAL)));
