...
/**
 * This is an object that contains data related to the invoice_polos table.
...
public abstract class BaseInvoicePolos  implements Serializable {

	public static String REF = "InvoicePolos";
	 ...
	 */
	public BaseInvoicePolos (long id) {
		this.setId(id);
		initialize();
	}
	...
	// collections
	private java.util.Set invoicePolosDetails;
	private java.util.Set invoicePolosPrepayments;
	...
	/**
	 * Return the value associated with the column: InvoicePolosDetails
	 */
	public java.util.Set getInvoicePolosDetails () {
		return invoicePolosDetails;
	}

	/**
	 * Set the value related to the column: InvoicePolosDetails
	 * @param invoicePolosDetails the InvoicePolosDetails value
	 */
	public void setInvoicePolosDetails (java.util.Set invoicePolosDetails) {
		this.invoicePolosDetails = invoicePolosDetails;
	}

	public void addToInvoicePolosDetails (com.mpe.financial.model.InvoicePolosDetail invoicePolosDetail) {
		if (null == getInvoicePolosDetails()) setInvoicePolosDetails(new java.util.HashSet());
		getInvoicePolosDetails().add(invoicePolosDetail);
	}



	/**
	 * Return the value associated with the column: InvoicePolosPrepayments
	 */
	public java.util.Set getInvoicePolosPrepayments () {
		return invoicePolosPrepayments;
	}

	/**
	 * Set the value related to the column: InvoicePolosPrepayments
	 * @param invoicePolosPrepayments the InvoicePolosPrepayments value
	 */
	public void setInvoicePolosPrepayments (java.util.Set invoicePolosPrepayments) {
		this.invoicePolosPrepayments = invoicePolosPrepayments;
	}

	public void addToInvoicePolosPrepayments (com.mpe.financial.model.InvoicePolosPrepayment invoicePolosPrepayment) {
		if (null == getInvoicePolosPrepayments()) setInvoicePolosPrepayments(new java.util.HashSet());
		getInvoicePolosPrepayments().add(invoicePolosPrepayment);
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.InvoicePolos)) return false;
		else {
			com.mpe.financial.model.InvoicePolos invoicePolos = (com.mpe.financial.model.InvoicePolos) obj;
			return (this.getId() == invoicePolos.getId());
		}
	}
