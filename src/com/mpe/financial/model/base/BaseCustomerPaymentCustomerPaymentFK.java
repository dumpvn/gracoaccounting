...
public abstract class BaseCustomerPaymentCustomerPaymentFK  implements Serializable {

	public static String REF = "CustomerPaymentCustomerPaymentFK";
	public static String PROP_AMOUNT = "Amount";


	// constructors
	public BaseCustomerPaymentCustomerPaymentFK () {
		initialize();
	}
