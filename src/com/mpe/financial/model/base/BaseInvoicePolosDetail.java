...
/**
 * This is an object that contains data related to the invoice_polos_detail table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="invoice_polos_detail"
 */

public abstract class BaseInvoicePolosDetail  implements Serializable {

	public static String REF = "InvoicePolosDetail";
	 ...
	 */
	public BaseInvoicePolosDetail (com.mpe.financial.model.InvoicePolosDetailPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.mpe.financial.model.InvoicePolosDetailPK id;
     ...
     * @hibernate.id
     */
	public com.mpe.financial.model.InvoicePolosDetailPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.mpe.financial.model.InvoicePolosDetailPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.InvoicePolosDetail)) return false;
		else {
			com.mpe.financial.model.InvoicePolosDetail invoicePolosDetail = (com.mpe.financial.model.InvoicePolosDetail) obj;
			if (null == this.getId() || null == invoicePolosDetail.getId()) return false;
			else return (this.getId().equals(invoicePolosDetail.getId()));
		}
	}
