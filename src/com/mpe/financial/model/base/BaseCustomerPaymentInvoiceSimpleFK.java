...
public abstract class BaseCustomerPaymentInvoiceSimpleFK  implements Serializable {

	public static String REF = "CustomerPaymentInvoiceSimpleFK";
	...
	// constructors
	public BaseCustomerPaymentInvoiceSimpleFK () {
		initialize();
	}
