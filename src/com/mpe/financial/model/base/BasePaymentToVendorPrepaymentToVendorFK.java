...
public abstract class BasePaymentToVendorPrepaymentToVendorFK  implements Serializable {

	public static String REF = "PaymentToVendorPrepaymentToVendorFK";
	public static String PROP_AMOUNT = "Amount";


	// constructors
	public BasePaymentToVendorPrepaymentToVendorFK () {
		initialize();
	}
