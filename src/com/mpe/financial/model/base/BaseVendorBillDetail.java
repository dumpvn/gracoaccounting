...
/**
 * This is an object that contains data related to the vendor_bill_detail table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="vendor_bill_detail"
 */

public abstract class BaseVendorBillDetail  implements Serializable {

	public static String REF = "VendorBillDetail";
	 ...
	 */
	public BaseVendorBillDetail (com.mpe.financial.model.VendorBillDetailPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.mpe.financial.model.VendorBillDetailPK id;
     ...
     * @hibernate.id
     */
	public com.mpe.financial.model.VendorBillDetailPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.mpe.financial.model.VendorBillDetailPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.VendorBillDetail)) return false;
		else {
			com.mpe.financial.model.VendorBillDetail vendorBillDetail = (com.mpe.financial.model.VendorBillDetail) obj;
			if (null == this.getId() || null == vendorBillDetail.getId()) return false;
			else return (this.getId().equals(vendorBillDetail.getId()));
		}
	}
