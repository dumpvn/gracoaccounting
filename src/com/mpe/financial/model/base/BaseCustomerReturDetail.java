...
/**
 * This is an object that contains data related to the customer_retur_detail table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="customer_retur_detail"
 */

public abstract class BaseCustomerReturDetail  implements Serializable {

	public static String REF = "CustomerReturDetail";
	...
	// constructors
	public BaseCustomerReturDetail () {
		initialize();
	}
	 ...
	 */
	public BaseCustomerReturDetail (com.mpe.financial.model.CustomerReturDetailPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.mpe.financial.model.CustomerReturDetailPK id;
     ...
     * @hibernate.id
     */
	public com.mpe.financial.model.CustomerReturDetailPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.mpe.financial.model.CustomerReturDetailPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.CustomerReturDetail)) return false;
		else {
			com.mpe.financial.model.CustomerReturDetail customerReturDetail = (com.mpe.financial.model.CustomerReturDetail) obj;
			if (null == this.getId() || null == customerReturDetail.getId()) return false;
			else return (this.getId().equals(customerReturDetail.getId()));
		}
	}
