...
public abstract class BaseCustomerPaymentInvoicePolosFK  implements Serializable {

	public static String REF = "CustomerPaymentInvoicePolosFK";
	...
	// constructors
	public BaseCustomerPaymentInvoicePolosFK () {
		initialize();
	}
