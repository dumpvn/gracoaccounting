...
public abstract class BaseArAgingDetailReport  implements Serializable {

	public static String REF = "ArAgingDetailReport";
	...
	// constructors
	public BaseArAgingDetailReport () {
		initialize();
	}
	 ...
	 */
	public BaseArAgingDetailReport (long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.ArAgingDetailReport)) return false;
		else {
			com.mpe.financial.model.ArAgingDetailReport arAgingDetailReport = (com.mpe.financial.model.ArAgingDetailReport) obj;
			return (this.getId() == arAgingDetailReport.getId());
		}
	}
