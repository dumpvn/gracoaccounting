...
/**
 * This is an object that contains data related to the delivery_order_detail table.
...
public abstract class BaseDeliveryOrderDetail  implements Serializable {

	public static String REF = "DeliveryOrderDetail";
	...
	// constructors
	public BaseDeliveryOrderDetail () {
		initialize();
	}
	 ...
	 */
	public BaseDeliveryOrderDetail (com.mpe.financial.model.DeliveryOrderDetailPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.mpe.financial.model.DeliveryOrderDetailPK id;
     ...
     * @hibernate.id
     */
	public com.mpe.financial.model.DeliveryOrderDetailPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.mpe.financial.model.DeliveryOrderDetailPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.DeliveryOrderDetail)) return false;
		else {
			com.mpe.financial.model.DeliveryOrderDetail deliveryOrderDetail = (com.mpe.financial.model.DeliveryOrderDetail) obj;
			if (null == this.getId() || null == deliveryOrderDetail.getId()) return false;
			else return (this.getId().equals(deliveryOrderDetail.getId()));
		}
	}
