...
/**
 * This is an object that contains data related to the invoice_simple_detail table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="invoice_simple_detail"
 */

public abstract class BaseInvoiceSimpleDetail  implements Serializable {

	public static String REF = "InvoiceSimpleDetail";
	...
	// constructors
	public BaseInvoiceSimpleDetail () {
		initialize();
	}
	 ...
	 */
	public BaseInvoiceSimpleDetail (com.mpe.financial.model.InvoiceSimpleDetailPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.mpe.financial.model.InvoiceSimpleDetailPK id;
     ...
     * @hibernate.id
     */
	public com.mpe.financial.model.InvoiceSimpleDetailPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.mpe.financial.model.InvoiceSimpleDetailPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.InvoiceSimpleDetail)) return false;
		else {
			com.mpe.financial.model.InvoiceSimpleDetail invoiceSimpleDetail = (com.mpe.financial.model.InvoiceSimpleDetail) obj;
			if (null == this.getId() || null == invoiceSimpleDetail.getId()) return false;
			else return (this.getId().equals(invoiceSimpleDetail.getId()));
		}
	}
