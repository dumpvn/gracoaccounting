...
/**
 * This is an object that contains data related to the receiving_detail table.
...
public abstract class BaseReceivingDetail  implements Serializable {

	public static String REF = "ReceivingDetail";
	 ...
	 */
	public BaseReceivingDetail (com.mpe.financial.model.ReceivingDetailPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.mpe.financial.model.ReceivingDetailPK id;
     ...
     * @hibernate.id
     */
	public com.mpe.financial.model.ReceivingDetailPK getId () {
		return id;
	}
	 ...
	 * @param id the new ID
	 */
	public void setId (com.mpe.financial.model.ReceivingDetailPK id) {
		this.id = id;
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.ReceivingDetail)) return false;
		else {
			com.mpe.financial.model.ReceivingDetail receivingDetail = (com.mpe.financial.model.ReceivingDetail) obj;
			if (null == this.getId() || null == receivingDetail.getId()) return false;
			else return (this.getId().equals(receivingDetail.getId()));
		}
	}
