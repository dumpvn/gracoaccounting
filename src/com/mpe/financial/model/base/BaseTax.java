...
public abstract class BaseTax  implements Serializable {

	public static String REF = "Tax";
	public static String PROP_NUMBER = "Number";
	public static String PROP_NAME = "Name";
	public static String PROP_QUANTITY = "Quantity";
	public static String PROP_AP = "Ap";
	...
	/**
	 * Return the value associated with the column: is_ap
	 */
	public boolean isAp () {
		return ap;
	}
	...
	/**
	 * Set the value related to the column: is_ap
	 * @param ap the is_ap value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.Tax)) return false;
		else {
			com.mpe.financial.model.Tax tax = (com.mpe.financial.model.Tax) obj;
			return (this.getId() == tax.getId());
		}
	}
