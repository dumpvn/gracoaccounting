...
/**
 * This is an object that contains data related to the invoice_simple table.
...
public abstract class BaseInvoiceSimple  implements Serializable {

	public static String REF = "InvoiceSimple";
	 ...
	 */
	public BaseInvoiceSimple (long id) {
		this.setId(id);
		initialize();
	}
	...
	// collections
	private java.util.Set invoiceSimpleDetails;
	private java.util.Set invoiceSimplePrepayments;
	...
	/**
	 * Return the value associated with the column: InvoiceSimpleDetails
	 */
	public java.util.Set getInvoiceSimpleDetails () {
		return invoiceSimpleDetails;
	}

	/**
	 * Set the value related to the column: InvoiceSimpleDetails
	 * @param invoiceSimpleDetails the InvoiceSimpleDetails value
	 */
	public void setInvoiceSimpleDetails (java.util.Set invoiceSimpleDetails) {
		this.invoiceSimpleDetails = invoiceSimpleDetails;
	}

	public void addToInvoiceSimpleDetails (com.mpe.financial.model.InvoiceSimpleDetail invoiceSimpleDetail) {
		if (null == getInvoiceSimpleDetails()) setInvoiceSimpleDetails(new java.util.HashSet());
		getInvoiceSimpleDetails().add(invoiceSimpleDetail);
	}



	/**
	 * Return the value associated with the column: InvoiceSimplePrepayments
	 */
	public java.util.Set getInvoiceSimplePrepayments () {
		return invoiceSimplePrepayments;
	}

	/**
	 * Set the value related to the column: InvoiceSimplePrepayments
	 * @param invoiceSimplePrepayments the InvoiceSimplePrepayments value
	 */
	public void setInvoiceSimplePrepayments (java.util.Set invoiceSimplePrepayments) {
		this.invoiceSimplePrepayments = invoiceSimplePrepayments;
	}

	public void addToInvoiceSimplePrepayments (com.mpe.financial.model.InvoiceSimplePrepayment invoiceSimplePrepayment) {
		if (null == getInvoiceSimplePrepayments()) setInvoiceSimplePrepayments(new java.util.HashSet());
		getInvoiceSimplePrepayments().add(invoiceSimplePrepayment);
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.mpe.financial.model.InvoiceSimple)) return false;
		else {
			com.mpe.financial.model.InvoiceSimple invoiceSimple = (com.mpe.financial.model.InvoiceSimple) obj;
			return (this.getId() == invoiceSimple.getId());
		}
	}
